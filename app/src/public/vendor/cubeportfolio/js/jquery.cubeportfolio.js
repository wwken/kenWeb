(function($, window, document, undefined) {
  ...
  $.extend(CubePortfolio.prototype, {
    ...
    responsiveLayout: function() {
      ...
      t.cols = t[
        $.isArray(t.options.mediaQueries)
    ...
    getColumnsAuto: function() {
      ...
      var columnWidth =
        t.blocks.first().data('cbp').widthInitial + t.options.gapVertical;
  ...
  $.fn.cubeportfolio = function(method, options, callback) {
    return this.each(function() {
      ...
      throw new Error(
        'Method ' + method + ' does not exist on jquery.cubeportfolio.js'
      );
    });
  };
  ...
  $.extend(CubePortfolio.prototype, {
    ...
    mosaicLayout: function() {
      ...
      for (var i = 0, blocksLen = t.blocksOn.length; i < blocksLen; i++) {
        ...
        t.generateF1F2(
          spaceIndexAndBlock.spaceIndex,
          spaceIndexAndBlock.dataBlock
        );
    ...
    getSpaceIndexAndBlock: function() {
      ...
      $.each(t.freeSpaces, function(index1, space) {
        ...
        t.blocksOn.each(function(index2, block) {
          ...
          if (
            data.widthAndGap <= widthSpace &&
            data.heightAndGap <= heightSpace
          ) {
    ...
    intersectSpaces: function(space1, block) {
      ...
      if (
        space1.leftStart === space2.leftStart &&
    ...
    removeNonMaximalFreeSpaces: function() {
      ...
      t.freeSpaces = $.map(t.freeSpaces, function(space1, index1) {
        $.each(t.freeSpaces, function(index2, space2) {
          ...
          if (
            space2.leftStart <= space1.leftStart &&
...
(function($, window, document, undefined) {
      ...
      t.scrollEvent = function() {
        ...
        $window.on(eventName, function() {
          ...
          timeout = setTimeout(function() {
            if (
              $.isFunction(beforeEventCallback) &&
              beforeEventCallback.call(t)
            ) {
              return;
            }
  ...
  CubePortfolio.private.resize = new CubePortfolio.private
    .publicEvents('resize.cbp', 50, function() {
  ...
  $.extend(CubePortfolio.prototype, {
    ...
    enableDisableNavSlider: function() {
      ...
      if (t.customPagination) {
        ...
        // add class active on pagination's items
        t.customPaginationItems
          .removeClass(t.customPaginationClass)
          .eq(page)
    ...
    updateSliderPosition: function() {
      ...
      if (CubePortfolio.private.modernBrowser) {
        t.$ul[0].style[CubePortfolio.private.transform] =
          'translate3d(' + value + 'px, 0px, 0)';
      } else {
...
(function($, window, document, undefined) {
  ...
  Plugin.prototype.filterLayout = function() {
    ...
    t.blocksOn2On.addClass('cbp-item-on2on').each(function(index, el) {
      var data = $(el).data('cbp');
      el.style[CubePortfolio.private.transform] =
        'translate3d(' +
        (data.leftNew - data.left) +
        'px, ' +
        (data.topNew - data.top) +
        'px, 0)';
    });
    ...
    if (t.blocksOn2Off.length) {
      t.blocksOn2Off
        .last()
        .data('cbp')
        .wrapper.one(CubePortfolio.private.animationend, animationend);
    } else if (t.blocksOff2On.length) {
      t.blocksOff2On
        .last()
        .data('cbp')
        .wrapper.one(CubePortfolio.private.animationend, animationend);
    } else if (t.blocksOn2On.length) {
      // this is used for sort feature to animate the items when sort API is triggered
      t.blocksOn2On
        .last()
        .one(CubePortfolio.private.transitionend, animationend);
    } else {
      animationend();
    }
  ...
  CubePortfolio.plugins.animationClassic = function(parent) {
    if (
      !CubePortfolio.private.modernBrowser ||
      $.inArray(parent.options.animationType, [
        'boxShadow',
        'fadeOut',
        'flipBottom',
        'flipOut',
...
(function($, window, document, undefined) {
  ...
  Plugin.prototype.filterLayout = function() {
    ...
    requestAnimationFrame(function() {
      ...
      t.blocksOn.removeClass('cbp-item-off').each(function(index, el) {
        ...
        if (t.options.animationType === 'sequentially') {
          data.wrapper[0].style[CubePortfolio.private.animationDelay] =
            index * 60 + 'ms';
        }
      });
    ...
    function animationend() {
      ...
      if (t.options.animationType === 'sequentially') {
        t.blocksOn.each(function(index, el) {
          $(el).data('cbp').wrapper[0].style[
            CubePortfolio.private.animationDelay
          ] =
            '';
        });
      }
    ...
    requestAnimationFrame(function() {
      ...
      if (onLength === 0 && offLength === 0) {
        ...
        itemsCloned
          ...
          .one(CubePortfolio.private.animationend, animationend);
      } else {
        t.blocksOn
          .last()
          .data('cbp')
...
(function($, window, document, undefined) {
      ...
      function() {
        ...
        parent.blocksOn.each(function(index, el) {
          el.style[CubePortfolio.private.animationDelay] =
            index * parent.options.displayTypeSpeed + 'ms';
        });
        ...
        parent.blocksOn
          .last()
          .one(CubePortfolio.private.animationend, function() {
  ...
  CubePortfolio.plugins.displayBottomToTop = function(parent) {
    if (
      !CubePortfolio.private.modernBrowser ||
      parent.options.displayType !== 'bottomToTop' ||
      parent.blocksOn.length === 0
    ) {
      return null;
    }
...
(function($, window, document, undefined) {
    ...
    parent.registerEvent(
      ...
      function() {
        ...
        parent.obj.style[CubePortfolio.private.animationDuration] =
          parent.options.displayTypeSpeed + 'ms';
  ...
  CubePortfolio.plugins.displayFadeIn = function(parent) {
    if (
      !CubePortfolio.private.modernBrowser ||
      (parent.options.displayType !== 'lazyLoading' &&
        parent.options.displayType !== 'fadeIn') ||
      parent.blocksOn.length === 0
    ) {
      return null;
    }
...
(function($, window, document, undefined) {
  ...
  CubePortfolio.plugins.displayFadeInToTop = function(parent) {
    if (
      !CubePortfolio.private.modernBrowser ||
      parent.options.displayType !== 'fadeInToTop' ||
      parent.blocksOn.length === 0
    ) {
      return null;
    }
...
(function($, window, document, undefined) {
  ...
  CubePortfolio.plugins.displaySequentially = function(parent) {
    if (
      !CubePortfolio.private.modernBrowser ||
      parent.options.displayType !== 'sequentially' ||
      parent.blocksOn.length === 0
    ) {
      return null;
    }
...
(function($, window, document, undefined) {
  ...
  Plugin.prototype.registerFilter = function() {
    ...
    t.filters.each(function(index, el) {
      ...
      t.filtersCallback(
        dropdown,
        items.filter('[data-filter="' + filterName + '"]')
      );
...
(function($, window, document, undefined) {
  ...
  function Plugin(parent) {
    ...
    parent.registerEvent('onMediaQueries', function(opt) {
      parent.options.gapVertical =
        opt && opt.hasOwnProperty('gapVertical')
          ? opt.gapVertical
          : gapVerticalInitial;
      parent.options.gapHorizontal =
        opt && opt.hasOwnProperty('gapHorizontal')
          ? opt.gapHorizontal
          : gapHorizontalInitial;
...
(function($, window, document, undefined) {
  ...
  Plugin.prototype.runInit = function() {
    ...
    t.parent.$obj
      ...
      .each(function(index, el) {
        var slider = $(el);
        var activeImage = slider
          .find('.cbp-slider-item--active')
          .find('img')[0];
...
(function($, window, document, undefined) {
  ...
  CubePortfolio.private.lazyLoadScroll = new CubePortfolio.private.publicEvents(
    'scroll.cbplazyLoad',
    50
  );
  ...
  Plugin.prototype.isElementInScreen = function(el) {
    ...
    var screenHeight =
      t.screenHeight + bottom - (bound.top - t.options.threshold);
...
(function($, window, document, undefined) {
  ...
  Plugin.prototype.auto = function() {
    ...
    CubePortfolio.private.loadMoreScroll = new CubePortfolio.private
      .publicEvents('scroll.loadMore', 100);
...
(function($, window, document, undefined) {
  ...
  var popup = {
    ...
    init: function(cubeportfolio, type) {
      ...
      if (type === 'singlePageInline') {
        ...
        if (t.options.singlePageInlineDeeplinking) {
          ...
          $.each(links, function(index, link) {
            t.cubeportfolio.blocksOn.each(function(index1, el) {
              var singlePageInline = $(el).find(
                t.options.singlePageInlineDelegate + '[href="' + link + '"]'
              );
          ...
          if (currentBlock) {
            t.cubeportfolio.registerEvent(
              'initFinish',
              function() {
                t.openSinglePageInline(
                  t.cubeportfolio.blocksOn,
                  currentBlock[0]
                );
              },
              true
        ...
        t.localOptions = $.extend(
          {},
          options,
          t.cubeportfolio.options.plugins.singlePageInline
        );
      ...
      if (type === 'singlePage') {
        ...
        if (t.options.singlePageDeeplinking) {
          ...
          $.each(links, function(index, link) {
            t.cubeportfolio.blocksOn.each(function(index1, el) {
              var singlePage = $(el).find(
                t.options.singlePageDelegate + '[href="' + link + '"]'
              );
          ...
          if (currentBlock) {
            ...
            if (gallery) {
              blocks = self
                .closest($('.cbp-item'))
                .find('[data-cbp-singlePage="' + gallery + '"]');
            } else {
              t.cubeportfolio.blocksOn.each(function(index, el) {
                ...
                if (item.not('.cbp-item-off')) {
                  item
                    .find(t.options.singlePageDelegate)
        ...
        t.localOptions = $.extend(
          {},
          options,
          t.cubeportfolio.options.plugins.singlePage
        );
      }
    },
    ...
    createMarkup: function() {
      ...
      if (t.type === 'singlePage') {
        if (t.options.singlePageAnimation !== 'left') {
          animationCls =
            ' cbp-popup-singlePage-' + t.options.singlePageAnimation;
        }
      }
    ...
    openSinglePage: function(blocks, currentBlock) {
      ...
      if (
        t.cubeportfolio.singlePageInline &&
        t.cubeportfolio.singlePageInline.isOpen
      ) {
      ...
      if (
        CubePortfolio.private.browser === 'ie8' ||
        CubePortfolio.private.browser === 'ie9'
      ) {
        $('html').css({
          overflow: 'hidden',
          marginRight: window.innerWidth - $(document).width(),
      ...
      if ($.isFunction(t.options.singlePageCallback)) {
        t.options.singlePageCallback.call(
          t,
          t.dataArray[t.current].url,
          t.dataArray[t.current].element
        );
      }
    ...
    openSinglePageInline: function(blocks, currentBlock, fromOpen) {
      ...
      // check singlePageInline and close it
      if (t.isOpen) {
        tempCurrent = t.cubeportfolio.blocksOn.index(
          $(currentBlock).closest('.cbp-item')
        );

        if (
          t.dataArray[t.current].url !== currentBlock.getAttribute('href') ||
          t.current !== tempCurrent
        ) {
      ...
      parentElement = $(t.dataArray[t.current].element)
        .parents('.cbp-item')
      ...
      if ($.isFunction(t.options.singlePageInlineCallback)) {
        t.options.singlePageInlineCallback.call(
          t,
          t.dataArray[t.current].url,
          t.dataArray[t.current].element
        );
    ...
    resizeSinglePageInline: function() {
      ...
      t.height =
        t.top === 0 || t.top === t.cubeportfolio.height
          ? t.wrap.outerHeight(true)
          : t.wrap.outerHeight(true) - t.options.gapHorizontal;
    ...
    isImage: function(el) {
      ...
      t.cubeportfolio.loadImages(
        $('<div><img src="' + el.src + '"></div>'),
        function() {
          t.updateImagesMarkup(
            el.src,
            el.title,
            t.getCounterMarkup(
    ...
    updateSelfHostedVideo: function(src, title, counter) {
      ...
      markup +=
        ...
        (title
          ? '<div class="cbp-popup-lightbox-title">' + title + '</div>'
          : '') +
        counter +
        '</div>' +
        '</div>';
    ...
    singlePageJumpTo: function(index) {
      ...
      if ($.isFunction(t.options.singlePageCallback)) {
        ...
        if (t.slider) {
          CubePortfolio.private.resize.destroyEvent(
            $.data(t.slider[0], 'cubeportfolio')
          );
        }
    ...
    close: function(method, data) {
      ...
      function finishClose() {
        ...
        t.cubeportfolio.$obj.removeClass(
    ...
    resizeImage: function() {
      ...
      var height =
        $(window).height() -
        (figure.outerHeight(true) - figure.height()) -
        this.content.find('.cbp-popup-lightbox-bottom').outerHeight(true);
    ...
    if (p.options.lightboxDelegate && !lightboxInit) {
      ...
      body.on('click.cbp', p.options.lightboxDelegate, function(e) {
        ...
        if (cbp) {
          ...
          if (gallery) {
            blocks = scope.find(
              p.options.lightboxDelegate + '[data-cbp-lightbox=' + gallery + ']'
            );
          } else {
      ...
      body.on('click.cbp', p.options.singlePageDelegate, function(e) {
        ...
        if (cbp) {
          cbp.blocksOn.each(function(index, el) {
            ...
            if (item.not('.cbp-item-off')) {
              item
                .find(p.options.singlePageDelegate)
                .each(function(index2, el2) {
                  if (gallery) {
...
(function($, window, document, undefined) {
  ...
  function Plugin(parent) {
    ...
    t.element.on('click.cbp', '.cbp-sort-item', function(event) {
      ...
      if (
        $(t.target).hasClass('cbp-l-dropdown-item--active') ||
        parent.isAnimating
      ) {
        return;
      }
    ...
    t.dropdownWrap = t.element.find('.cbp-l-dropdown-wrap').on({
      'mouseover.cbp': function() {
