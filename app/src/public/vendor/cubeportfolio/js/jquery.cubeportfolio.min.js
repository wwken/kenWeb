...
!(function(e, t, n, o) {
            ...
            return r[n] > s[n]
              ...
              : r[n] < s[n]
                ...
                : r[o] > s[o]
                  ...
                  : r[o] < s[o]
                    ? -i
                    : r.index > s.index ? i : r.index < s.index ? -i : void 0;
          });
      },
    });
  })(jQuery, window, document),
  ...
  (function(e, t, n, o) {
    ...
    (i['private'] = {
      ...
      (i['private'].resize = new i['private']
      ...
      getFreeSpacesForSlider: function() {
        ...
        (e.freeSpaces = e.sliderFreeSpaces.slice(
          ...
          e.freeSpaces.sort(function(e, t) {
            return e.topStart > t.topStart
              ? 1
              : e.topStart < t.topStart ? -1 : void 0;
          });
      },
          ...
          'singlePage' === t.type &&
            ...
            'singlePage' === t.type &&
              (t.options.singlePageCounter &&
                ...
                t.counter.text('')),
              t.content.on('click.cbp', t.options.singlePageDelegate, function(
                e
              ) {
                e.preventDefault();
                var o,
              ...
              t.contentWrap.on('mousewheel.cbp DOMMouseScroll.cbp', function(
                e
              ) {
    ...
    (i.prototype.run = function() {
      ...
      (o.lightbox = null),
        ...
        o.options.singlePageInlineDelegate &&
          ...
          o.$obj.on('click.cbp', o.options.singlePageInlineDelegate, function(
            t
          ) {
            t.preventDefault();
