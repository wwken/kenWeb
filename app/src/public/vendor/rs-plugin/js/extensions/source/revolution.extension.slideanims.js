...
*************************************/
  ...
  var animateSlideIntern = function(
    ...
    if (
      nextsh.data('kenburns') == 'on' //|| actsh.data('kenburns')=="on")
    )
      nexttrans = 11;
    ...
    masterspeed =
      masterspeed === 'default'
        ...
        : masterspeed === 'random'
          ...
          : masterspeed != undefined ? parseInt(masterspeed, 0) : STA[11];
    ...
    opt.slots =
      nexttrans == 9
        ? opt.width / opt.slots
        : nexttrans == 10 ? opt.height / opt.slots : opt.slots;
          ...
          if (i < pieces) {
            var t = jQuery(this),
              ...
              ftop =
                _nt == 31
                  ? sh / 2 - nh / 2
                  : _nt == 32 ? sh / 2 - nh / 2 : sh / 2 - nh / 2,
              fleft =
                _nt == 33
                  ? sw / 2 - nw / 2
                  : _nt == 34 ? sw - nw : sw / 2 - nw / 2,
              fa = {
                scale: 1,
    ...
    if (nexttrans == 19 || nexttrans == 22) {
      ...
      nextsh.find('.slotslide').each(function(j) {
        ...
        subtl.add(
          punchgs.TweenLite.to(ss, 0.1, { autoAlpha: 1, delay: j * 50 / 1000 }),
          0
        );
        mtl.add(subtl);
      });
