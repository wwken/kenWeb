            ...
            jQuery.each(opt.timelines.staticlayers.layers, function(key, o) {
              var _ = o.layer.data(),
                ...
                isvisible =
                  _.animdirection === 'in'
                    ? true
                    : _.animdirection === 'out' ? false : undefined,
    ...
    prepareSingleCaption: function(obj) {
      ...
      _._isgroup =
        _._isgroup === undefined
          ? _nc.hasClass('rev_group') ? true : false
          : _._isgroup;
      ...
      _._row =
        _._row === undefined
          ? _._nctype === 'column' ? _._pw.closest('.rev_row') : false
          : _._row;
      ...
      elx =
        elx === 'center' || elx === 'middle'
          ...
          : elx === 'left'
            ...
            : elx === 'right'
              ? crw - _.eow - hofs
              : _._respoffset !== 'off' ? elx * opt.bw : elx;
      ely =
        ely == 'center' || ely == 'middle'
          ...
          : ely == 'top'
            ...
            : ely == 'bottom'
              ? crh - _.eoh - vofs
              : _._respoffset !== 'off' ? ely * opt.bw : ely;
      ...
      tweens.content.eventCallback(
        ...
        function(frame_index, ncobj, pw, _, tl, toanim, _nc, ust) {
          ...
          data.eventtype =
            frame_index === 0
              ? 'enterstage'
              : frame_index === _.outframeindex ? 'leavestage' : 'framestarted';
