...
(function($) {
  ...
  var initMouseScroll = function(container, opt) {
    ...
    var bl = opt.ischrome
        ...
        : opt.isIEEleven || opt.isSafari
          ? -9
          : navigator.userAgent.match(/mozilla/i) ? -29 : -49,
      tl = opt.ischrome
        ? 49
        : opt.isIEEleven || opt.isSafari
          ? 9
            ...
            case 'move':
              ...
              curpos =
                curpos > 0
                  ? tdir === 'horizontal'
                    ? curpos -
                      el.width() * (curpos / el.width() * curpos / el.width())
                    : curpos -
                      el.height() *
  ...
  var addBullet = function(container, o, li, opt) {
    ...
    b
      ...
      .css({ backgroundImage: 'url(' + opt.thumbs[li.index()].src + ')' });
