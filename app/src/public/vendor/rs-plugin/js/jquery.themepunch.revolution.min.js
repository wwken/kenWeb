      ...
      (b.carousel.maxVisibleItems =
        ...
        (b.carousel.vertical_align =
          'top' === b.carousel.vertical_align
            ? '0%'
            : 'bottom' === b.carousel.vertical_align ? '100%' : '50%');
    },
          ...
          var e =
            'backgroundvideo' == d.layer
              ...
              : 'firstvideo' == d.layer
                ...
                : jQuery('#' + d.layer);
          switch ((jQuery.inArray(d.action, [
            'toggleslider',
            'toggle_mute_video',
  ...
  jQuery.extend(!0, b, {
    prepareCarousel: function(a, d, h, i) {
      return (
        ...
        void (void 0 !== i
          ? g(a, h, !1, 0)
          : void 0 == d ? b.carouselToEvalPosition(a, h) : g(a, h, !1)))
      );
    },
    carouselToEvalPosition: function(a, c) {
      ...
      (j =
        (i >= 0.3 && 'left' === c) || (i >= 0.7 && 'right' === c)
          ? k
          : (i < 0.3 && 'left' === c) || (i < 0.7 && 'right' === c) ? l : j),
        (j =
          'off' === d.infinity
            ? h < 0 ? h : e > a.slideamount - 1 ? e - (a.slideamount - 1) : j
            : j),
          ...
          'on' === e.infinity &&
            ...
            (i =
              i < 0 - e.inneroffset - e.slide_width
                ? 'left' == b
                  ? i + e.maxwidth
                  : 'right' === b ? f[g - 1] + (d + 1) * e.slide_width : i
                : i));
          var j = new Object();
        ...
        (c.wrapwidth =
          'auto' != a.sliderLayout
            ? c.wrapwidth > a.c.closest('.tp-simpleresponsive').width()
              ...
              : c.wrapwidth
            : c.wrapwidth > a.ul.width() ? a.ul.width() : c.wrapwidth),
          ...
          var f = a.bgposition.split(' ') || 'center center',
            g =
              'center' == f[0]
                ...
                : 'left' == f[0] || 'left' == f[1]
                  ? '0%'
                  : 'right' == f[0] || 'right' == f[1] ? '100%' : f[0],
            h =
              'center' == f[1]
                ? '50%'
                : 'top' == f[0] || 'top' == f[1]
                  ? '0%'
                  : 'bottom' == f[0] || 'bottom' == f[1] ? '100%' : f[1];
    ...
    prepareSingleCaption: function(a) {
      ...
      if (
        ...
        if ('full-proportional' === q) {
          ...
          (q = x
            ? v
            : !jQuery.isNumeric(q) && q.indexOf('%') > 0 ? q : parseFloat(q)),
            (t = y
              ? w
              : !jQuery.isNumeric(t) && t.indexOf('%') > 0 ? t : parseFloat(t));
        (q = void 0 === q ? 0 : q),
          (t = void 0 === t ? 0 : t),
          'off' !== d._responsive
            ? ('grid' != d._ba && x
          ...
          function(a, c, d, e, f, g, h, i) {
            ...
            if (
              ...
              (k.eventtype =
                0 === a
                  ? 'enterstage'
                  : a === e.outframeindex ? 'leavestage' : 'framestarted'),
          ...
          function(a, d, e, f, g, h, i) {
            ...
            (k.layer = c),
              (k.eventtype =
                0 === a
                  ? 'enteredstage'
                  : a === d - 1 || a === e ? 'leftstage' : 'frameended'),
  ...
  var e = function(a, b) {
                ...
                D =
                  'vertical' === A
                    ? y
                        .find(w)
                        .first()
                        .outerHeight(!0) + x.space
                    : y
                        .find(w)
                        .first()
                        .outerWidth(!0) + x.space,
                E =
                ...
                case 'move':
                    ...
                    (F =
                      F > 0
                        ? 'horizontal' === A
                          ...
                          : F - z.height() * (F / z.height() * F / z.height())
                        : F);
                  var G =
                    'vertical' === A
                      ? 0 - (z.height() - y.height())
                  ...
                  (F =
                    F < G
                      ? 'horizontal' === A
                        ? F +
                          z.width() * (F - G) / z.width() * (F - G) / z.width()
                        : F +
                          z.height() *
                            (F - G) /
                            z.height() *
    ...
    w = function(a, b, c, d, e) {
      ...
      if (
        ...
        'outer-top' === b.position
          ? a.parent().prepend(l)
          : 'outer-bottom' === b.position ? a.after(l) : a.append(l),
                ...
                'carousel' === e.sliderType &&
                  ...
                  e.c.find(t).each(function() {
                    var a = jQuery(this),
                      ...
                      g = l * c,
                      h =
                        0 == e.conw ? 0 : Math.round(k / e.conw * c * 100) || 0,
                      i =
                        0 == e.conh ? 0 : Math.round(l / e.conh * c * 100) || 0,
                      j = a.closest('li'),
                      n = 0,
                      o = !1;
                ...
                'carousel' === e.sliderType &&
                  ...
                  e.c.find(o).each(function() {
                    var a = jQuery(this),
                      ...
                      g = l * c * 3,
                      h =
                        0 == e.conw ? 0 : Math.round(k / e.conw * c * 500) || 0,
                      i =
                        0 == e.conh ? 0 : Math.round(l / e.conh * c * 700) || 0,
                      j = a.closest('li'),
                      n = 0,
                      o = !1;
                    a.hasClass('dddwrapper-layer') &&
      ...
      if (
        ...
        (a.conh =
          0 === a.conh || void 0 === a.conh
            ? a.infullscreenmode ? a.minHeight : a.c.height()
            : a.conh),
        ...
        (l.slots =
          l.slots < 1
            ? 'boxslide' == b
              ...
              : 'flyin' == b ? Math.round(4 * Math.random() + 1) : l.slots
            : l.slots),
    ...
    manageVideoLayer: function(a, g, i, j) {
      ...
      var l = a.data(),
        ...
        w =
          'loop' == l.videoloop
            ? 'loop'
            : 'loopandnoslidestop' == l.videoloop ? 'loop' : '',
        x =
          void 0 != q || void 0 != r
            ? 'html5'
            : void 0 != n && String(n).length > 1
              ? 'youtube'
              : void 0 != o && String(o).length > 1 ? 'vimeo' : 'none',
        ...
        z =
          'html5' == x && 0 == a.find(y).length
            ...
            : 'youtube' == x && 0 == a.find('iframe').length
              ? 'youtube'
              : 'vimeo' == x && 0 == a.find('iframe').length ? 'vimeo' : 'none';
