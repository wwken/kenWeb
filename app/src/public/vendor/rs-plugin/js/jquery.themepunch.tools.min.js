        ...
        if (a >= i - 1e-7)
          ...
          (1 === m || (3 === m && k >= 0.5)) && (k = 1 - k),
            ...
            1 === n
              ...
              : 2 === n
                ? (k *= k * k)
                : 3 === n ? (k *= k * k * k) : 4 === n && (k *= k * k * k * k),
            1 === m
              ? (this.ratio = 1 - k)
              : 2 === m
                ? (this.ratio = k)
                : 0.5 > a / i ? (this.ratio = k / 2) : (this.ratio = 1 - k / 2);
          ...
          if (
            ...
            if (((n = e.indexOf('=')), -1 === n))
              return null == this._labels[e]
                ? s ? (this._labels[e] = this.duration() + i) : i
                : this._labels[e] + i;
                  ...
                  (k.rotation = ja(
                    'rotation' in z
                      ...
                      : 'shortRotation' in z
                        ...
                        : 'rotationZ' in z ? z.rotationZ : C.rotation - C.skewY,
                    C.rotation - C.skewY,
                    'rotation',
                    A
                  )),
        ...
        (x = w[r]),
          ...
          'BR' !== x.nodeName
            ? (J &&
                ...
                (A.height = x._h + 'px')),
              H
                ? o && '' !== x.innerHTML ? da.push(x) : I && ca.push(x)
                : o
