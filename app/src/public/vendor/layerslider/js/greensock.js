            ...
            if (
              ...
              if (((f = b.indexOf('=')), -1 === f))
                return null == this._labels[b]
                  ? d ? (this._labels[b] = this.duration() + c) : c
                  : this._labels[b] + c;
              (c =
          ...
          ga = function(a, b) {
            ...
            var c,
              ...
              e =
                -1 !== a.indexOf('left')
                  ? '0%'
                  : -1 !== a.indexOf('right') ? '100%' : d[0],
              f =
                -1 !== a.indexOf('top')
                  ? '0%'
                  : -1 !== a.indexOf('bottom') ? '100%' : d[1];
            if (d.length > 3 && !b) {
              for (
                d = a
                  .split(', ')
              ...
              if (
                ...
                for (
                  ...
                  (z = ea[va]),
                    ...
                    (A =
                      c !== d[z]
                        ? 2 > va ? -d.ieOffsetX : -d.ieOffsetY
                        : 2 > va ? n - d.ieOffsetX : o - d.ieOffsetY),
                    (l[z] =
                      (d[z] = Math.round(
                        c - A * (0 === va || 2 === va ? 1 : B)
                      )) + 'px');
...
!(function(a, b) {
  'function' == typeof define && define.amd
    ? define(b)
    : 'undefined' != typeof exports ? (module.exports = b()) : b();
})(this, function() {
