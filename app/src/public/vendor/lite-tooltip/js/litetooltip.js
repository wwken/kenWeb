...
(function($) {
      ...
      if (plugin.settings.title != '') {
        ...
        if (plugin.settings.trigger == 'hoverable') {
          ...
          $element.bind(
            ...
            plugin.mouseOutHandler
          );
        } else if (plugin.settings.trigger == 'hover') {
          $element.bind(
            'mouseenter',
            { settings: plugin.settings, element: $element, $plugin: plugin },
            plugin.mouseOverHandler
          );
          $element.bind(
            'mouseleave',
  ...
  LiteTooltip.prototype = {
    getSettings: function(settings, element) {
      var issticky =
        element.data('issticky') != null
          ? element.data('issticky') == 'true' ? true : false
          : true;
      var $settings = $.extend({}, settings, {
        location: element.data('location'),
        title: element.data('title'),
        backcolor: element.data('backcolor'),
        textalign: element.data('textalign'),
        trigger: element.data('trigger'),
        textcolor: element.data('textcolor'),
        opacity: element.data('opacity'),
        templatename: element.data('templatename'),
    ...
    mouseOverHandler: function(e) {
      ...
      var tooltip_margin = parseInt(
        $settings.margin.toString().replace('px', '')
      );
      var tooltip_padding = parseInt(
        $settings.padding.toString().replace('px', '')
      );
      var tooltip_width = parseInt(
        $settings.width.toString().replace('px', '')
      );
      var tooltip_location =
        $settings.container == 'body' ? $settings.location : 'none';
      ...
      tooltip
        ...
        .css({ background: tooltip_backcolor, 'text-align': tooltip_textalign })
        .html($settings.title + $settings.clearfix);
      tooltip
        .find('.tooltip-content')
        .css({ color: tooltip_textcolor, padding: tooltip_padding + 'px' });
      if ($settings.shadow == 1) {
        tooltip
          .find('.tooltip-content')
          .css({ 'box-shadow': '1px 1px 3px 0px #888888' });
      }
      ...
      tooltip
        .find('.tooltip-arrow')
        .removeClass(tooltip_location)
        .addClass(tooltip_arrow_css)
        .css('border-' + tooltip_arrow_border + '-color', tooltip_backcolor);
      ...
      if ($settings.container == 'body') {
        ...
        if (thisElement.tagName.toLowerCase() == 'area') {
          ...
          var areaX = parseInt(
            thisElement.getAttribute('coords').split(',')[0]
          );
          var areaY = parseInt(
            thisElement.getAttribute('coords').split(',')[1]
          );
          var areaWidth = parseInt(
            thisElement.getAttribute('coords').split(',')[2]
          );
          var areaHeight = parseInt(
            thisElement.getAttribute('coords').split(',')[3] || areaWidth
          );
          var hotspotOffset = {
            top: parseInt(imgTop + areaY),
            left: parseInt(imgLeft + areaX),
          };

          if (areaShape == 'circle') {
            hotspotOffset = {
              top: parseInt(imgTop + areaY - areaWidth),
              left: parseInt(imgLeft + areaX - areaWidth),
            };
            areaWidth *= 2;
            areaHeight *= 2;
          }
          ...
          if (areaShape == 'poly') {
            ...
            for (var index = 0; index < splitCoords.length; ) {
              coords.push({
                x: parseInt(splitCoords[index]),
                y: parseInt(splitCoords[index + 1]),
              });
              index = index + 2;
            }
            ...
            // ------------------------------------
            hotspotOffset = {
              top: parseInt(imgTop + minY),
              left: parseInt(imgLeft + minX),
            };
        ...
        switch (tooltip_location) {
          case 'top':
            // top
            tooltip_offset = {
              top: elementTop - tooltipHeight - tooltip_margin,
              left: elementLeft - tooltipWidth / 2 + elementWidth / 2,
            };
            break;
          case 'top-left':
            // top-left
          ...
          case 'top-right':
            ...
            tooltip_offset = {
              top: elementTop - tooltipHeight - tooltip_margin,
              left: elementLeft - tooltipWidth + elementWidth,
            };
            break;
          // ************************
          case 'right':
            ...
            tooltip_offset = {
              ...
              left: elementLeft + elementWidth + tooltip_margin,
            };
            break;
          case 'right-top':
            // right-top
            tooltip_offset = {
              top: elementTop + elementHeight - tooltipHeight + 8,
              left: elementLeft + elementWidth + tooltip_margin,
            };
            break;
          case 'right-bottom':
          ...
          case 'bottom':
            // bottom
            tooltip_offset = {
              top: elementTop + elementHeight + tooltip_margin,
              left: elementLeft - tooltipWidth / 2 + elementWidth / 2,
            };
            break;
          case 'bottom-left':
          ...
          case 'left':
            ...
            tooltip_offset = {
              top: elementTop + elementHeight / 2 - tooltipHeight / 2,
              left: elementLeft - tooltipWidth - tooltip_margin,
            };
            break;
          case 'left-top':
            // left-top
        ...
        var tooltipHeightOverflow =
          tooltip_arrow_css.match('bottom') != null ||
          tooltip_arrow_css == 'left' ||
          tooltip_arrow_css == 'right'
            ? (tooltip_arrow_css == 'left' || tooltip_arrow_css == 'right'
                ? tooltipHeight / 2
                : tooltipHeight) >
        ...
        if (
          tooltip_offset.left < 0 ||
          tooltip_offset.top < 0 ||
          tooltip_offset.left + tooltipWidth > windowWidth ||
          tooltipHeightOverflow
        ) {
          if (
            tooltip_arrow_border == 'top' ||
            tooltip_arrow_border == 'bottom' ||
            tooltip_arrow_border == 'left' ||
            tooltip_arrow_border == 'right'
          ) {
            var flag3 = false;
            switch (tooltip_arrow_border) {
              case 'top':
                tooltip_offset.top =
                  elementTop - tooltipHeight - tooltip_margin;
                tooltip_offset.left =
                  elementLeft - tooltipWidth / 2 + elementWidth / 2;
                flag3 = true;
                break;
              case 'bottom':
                tooltip_offset.top =
                ...
                break;
              case 'left':
                var temp_tooltip_arrow_border = tooltip_arrow_css.replace(
                ...
                if (temp_tooltip_arrow_border == 'top') {
                  ...
                  tooltip
                    .removeClass(original_tooltip_arrow_css)
                    .addClass(tooltip_arrow_css);
                  tooltip
                    .find('.tooltip-arrow')
                    .removeClass(original_tooltip_arrow_css)
                    .css(
                      'border-' + original_tooltip_arrow_border + '-color',
                      ''
                    )
                    .addClass(tooltip_arrow_css)
                    .css(
                      'border-' + tooltip_arrow_border + '-color',
                      tooltip_backcolor
                    );
                  ...
                  tooltipHeight = tooltip.outerHeight();
                  tooltip_offset.top =
                    elementTop + elementHeight + tooltip_margin;
                  tooltip_offset.left =
                    elementLeft - tooltipWidth / 2 + elementWidth / 2;
                  original_tooltip_offset.left = elementLeft;
                  original_tooltip_offset.top =
            ...
            if (flag3) {
              ...
              if (tooltip_offset.top < 0) {
                ...
                if (tooltip_offset.left + tooltipWidth > windowWidth) {
                  // set left here
                  tooltip_offset.left =
                    elementLeft - tooltipWidth + elementWidth;
                  if (tooltip_offset.left < 0) {
                    // bottom
                    tooltip_arrow_border = 'bottom';
                    tooltip_arrow_css = 'bottom';
              ...
              if (!flag1) {
                if (flag2) {
                  tooltip_arrow_css = original_tooltip_arrow_css.replace(
                    'top',
                    'bottom'
                  );
                  tooltip_arrow_border = original_tooltip_arrow_border.replace(
                    'top',
                    'bottom'
                  );
                  ...
                  if (original_tooltip_offset.left < 0) {
                    if (
                      ...
                      tooltip_arrow_css = tooltip_arrow_css.replace(
                        'right',
                        'left'
                      );
                      tooltip_offset.left = elementLeft;
        ...
        tooltip
          .find('.tooltip-arrow')
          .removeClass(original_tooltip_arrow_css)
          .css('border-' + original_tooltip_arrow_border + '-color', '')
          .addClass(tooltip_arrow_css)
          .css('border-' + tooltip_arrow_border + '-color', tooltip_backcolor);

        if (tooltip_templatename != '') {
          if (
            tooltip.find('.tooltip-content > .template').hasClass('template')
          ) {
            tooltip
              .find('.tooltip-content > .template')
              .addClass(tooltip_templatename);
            var tooltip_template_backcolor = tooltip
              .find('.' + tooltip_templatename)
            ...
            tooltip
              .find('.tooltip-content')
              .css({ background: tooltip_template_backcolor });
          } else if (
            tooltip
              .find('.tooltip-content > .tooltip-menu')
              .hasClass('tooltip-menu')
          ) {
            tooltip
              .find('.tooltip-content > .tooltip-menu')
              .addClass(tooltip_templatename);
        ...
        tooltip
          .find('.tooltip-content > .video-wrapper')
          .css({ width: tooltip.width() - tooltip_padding * 2 + 'px' });
      ...
      if (
        e.data.settings.trigger == 'hoverable' ||
        e.data.settings.trigger == 'click'
      ) {
        tooltip_delay = 0;
      }
      ...
      switch (tooltip_arrow_border) {
        case 'top':
          tooltip
            .delay(tooltip_delay)
            .css({ top: '-=20', opacity: 0, display: 'block' })
            .stop(true, true)
            .animate({ top: '+=20', opacity: $settings.opacity }, 150);
          break;
        case 'bottom':
          tooltip
            .delay(tooltip_delay)
        ...
        case 'left':
          tooltip
            .delay(tooltip_delay)
            .css({ left: '-=20', opacity: 0, display: 'block' })
            .stop(true, true)
            .animate({ left: '+=20', opacity: $settings.opacity }, 150);
          break;
        case 'right':
          tooltip
            .delay(tooltip_delay)
        ...
        default:
          tooltip
            ...
            .stop(true, true)
            .animate({ opacity: $settings.opacity }, 150);
          break;
      }
        ...
        if (e.data.settings.trigger == 'hover') {
          ...
          if (e.data.settings.trigger == 'click') {
            if (!e.data.settings.issticky) {
              e.data.settings.interval = setInterval(function() {
                ...
                e.data.element.bind(
                  ...
                  e.data.$plugin.mouseOverHandler
                );
                e.data.element.bind(
                  'mouseleave',
                  {
      ...
      if (animateIt) {
        switch (e.data.$plugin.tooltip_arrow_border) {
          case 'top':
            $(tooltip)
              .stop(true, true)
              .animate({ top: '-=20', opacity: 0 }, 150, function() {
                $(e.data.$plugin.tooltip).remove();
              });
            break;
          case 'bottom':
          ...
          case 'left':
            $(tooltip)
              .stop(true, true)
              .animate({ left: '-=20', opacity: 0 }, 150, function() {
                $(e.data.$plugin.tooltip).remove();
              });
            break;
          case 'right':
  ...
  $.fn.LiteTooltip.defaultSettings = {
    ...
    textcolor: '#ffffff',
    template:
      '<div class="litetooltip-wrapper"><div class="tooltip-arrow"></div><div class="tooltip-content"></div></div>',
    margin: 5,
    padding: 10,
    width: 0,
    textalign: 'center',
