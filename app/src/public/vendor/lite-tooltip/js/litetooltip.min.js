(function(a) {
      ...
      if (g.settings.title != '') {
        ...
        if (g.settings.trigger == 'hoverable') {
          ...
          if (g.settings.trigger == 'hover') {
            e.bind(
              'mouseenter',
              { settings: g.settings, element: e, $plugin: g },
              g.mouseOverHandler
            );
            e.bind(
              'mouseleave',
  ...
  b.prototype = {
    getSettings: function(f, d) {
      var e =
        d.data('issticky') != null
          ? d.data('issticky') == 'true' ? true : false
          : true;
      var c = a.extend({}, f, {
    ...
    mouseOverHandler: function(n) {
      ...
      K.find('.tooltip-content')
        .css({ background: N, 'text-align': W })
      ...
      K.find('.tooltip-arrow')
        .removeClass(Q)
        .addClass(M)
        .css('border-' + L + '-color', N);
      var l = d.container;
      if (d.container != 'body') {
      ...
      if (d.container == 'body') {
        ...
        F.top = S.top;
        var aa =
          M.match('bottom') != null || M == 'left' || M == 'right'
            ? (M == 'left' || M == 'right' ? Z / 2 : Z) > ad - q - o
            : false;
        ...
        if (V != '') {
          if (K.find('.tooltip-content > .template').hasClass('template')) {
            ...
            if (
              K.find('.tooltip-content > .tooltip-menu').hasClass(
                'tooltip-menu'
              )
            ) {
      ...
      c.removeAttr('alt');
      if (
        n.data.settings.trigger == 'hoverable' ||
        n.data.settings.trigger == 'click'
      ) {
        P = 0;
      }
      switch (L) {
        case 'top':
          K.delay(P)
            ...
            .stop(true, true)
            .animate({ top: '+=20', opacity: d.opacity }, 150);
          break;
        case 'bottom':
          K.delay(P)
            .css({ top: '+=20', opacity: 0, display: 'block' })
        ...
        case 'left':
          K.delay(P)
            ...
            .stop(true, true)
            .animate({ left: '+=20', opacity: d.opacity }, 150);
          break;
        case 'right':
          K.delay(P)
            .css({ left: '+=20', opacity: 0, display: 'block' })
