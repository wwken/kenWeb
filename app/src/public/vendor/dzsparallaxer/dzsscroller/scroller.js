...
(function($) {
  $.fn.scroller = function(o) {
    var defaults = {
      ...
      settings_chrome_multiplier: 0.1, //scrollmultiplier for chrome
      settings_safari_multiplier: 0.2, //scrollmultiplier for safari
    ...
    this.each(function() {
      ...
      function init() {
        ...
        if (
          o.settings_scrollTop_height_indicator &&
          o.settings_scrollTop_height_indicator.outerHeight
        ) {
        ...
        if (o.type == 'scrollTop') {
          ...
          $(document).delegate('a[href^=#]', 'click', function() {
            ...
            if ($(_t23.attr('href')).length > 0) {
              ...
              if (
                $('.scroller-con.type-scrollTop').get(0) &&
                $('.scroller-con.type-scrollTop').get(0).api_scrolly_to
              ) {
        ...
        if (
          _inner &&
          (_inner.get(0).style.height == '' ||
            _inner.get(0).style.height == 'auto')
        ) {
        ...
        if (o.settings_autoheight == 'auto') {
          if (
            cthis.get(0).style.height == '' ||
            cthis.get(0).style.height == 'auto'
          ) {
        ...
        if (
          cthis.hasClass('is-touch') &&
          o.settings_disableSpecialIosFeatures == 'off'
        ) {
            ...
            if (is_android() || is_ios()) {
              ...
              if (dir_ver) {
                ...
                if (o.easing_type == 'easeIn') {
                  target_viy = Number(
                    Math.easeIn(1, begin_viy, change_viy, duration_viy).toFixed(
                      4
                    )
                  );
                }
                ...
                if (o.type == 'scrollTop') {
                  ...
                  if (
                    o.settings_scrollTop_animate_top_instead_of_scroll == 'on'
                  ) {
                    _window_object.css({
                      top: parseInt(target_viy, 10),
                    });
              ...
              if (dir_hor) {
                ...
                target_vix = Number(
                  Math.easeIn(1, begin_vix, change_vix, duration_viy).toFixed(4)
                );
      ...
      function inter_hidescrollbar_func() {
        ...
        if (o.settings_show_sidebar_on_right_side_mouse == 'on') {
          ...
          if (
            mousex > cthis.offset().left + cthis.width() - 100 &&
            mousex <= cthis.offset().left + cthis.width() &&
            mousey > cthis.offset().top &&
            mousey <= cthis.offset().top + cthis.height()
          ) {
      ...
      function handle_touchStart(e) {
        ...
        swipe_maintargetoriginalposx = parseInt(
          swipe_maintarget.css('left'),
          10
        );
        swipe_maintargetoriginalposy = parseInt(
          swipe_maintarget.css('top'),
          10
        );
      ...
      function handle_touchMove(e) {
        ...
        if (swipe_dragging == false) {
          ...
          if (dir_hor) {
            ...
            swipe_maintargettargetposx =
              swipe_maintargetoriginalposx +
              (swipe_touchupposx - swipe_touchdownposx);
            if (swipe_maintargettargetposx > 0) {
              swipe_maintargettargetposx /= 2;
            }
            if (
              swipe_maintargettargetposx <
              -swipe_maintargettotalclipwidth + swipe_maintargettotalwidth
            ) {
              swipe_maintargettargetposx =
                swipe_maintargettargetposx -
                (swipe_maintargettargetposx +
                  swipe_maintargettotalclipwidth -
                  swipe_maintargettotalwidth) /
                  2;
            }
          ...
          if (dir_ver) {
            ...
            //console.info(swipe_maintargetoriginalposy, swipe_touchupposy, swipe_touchdownposy)
            swipe_maintargettargetposy =
              swipe_maintargetoriginalposy +
              (swipe_touchupposy - swipe_touchdownposy);
            if (swipe_maintargettargetposy > 0) {
              swipe_maintargettargetposy /= 2;
            }
            if (
              swipe_maintargettargetposy <
              -swipe_maintargettotalclipheight + swipe_maintargettotalheight
            ) {
              swipe_maintargettargetposy =
                swipe_maintargettargetposy -
                (swipe_maintargettargetposy +
                  swipe_maintargettotalclipheight -
                  swipe_maintargettotalheight) /
                  2;
            }
            //console.log(swipe_maintargettargetposy);
      ...
      function calculateDims() {
        ...
        if (o.type == 'scrollTop') {
          ...
          if (
            _scrollTop_height_indicator &&
            _scrollTop_height_indicator.outerHeight
          ) {
            comHeight =
              _scrollTop_height_indicator.outerHeight() + comHeight_surplus;
          }

          //console.info(comHeight,last_comHeight);
          if (Math.abs(comHeight - last_comHeight) > 99) {
            viewIndexY =
              scrollIndexY / -(wh - scrollbary_psize) * (comHeight - wh);
        ...
        if (scrollbary == undefined && dir_ver) {
          ...
          scrollbary_bg.mousedown(function(event) {
            ...
            o.settings_slideshow = 0;
            scrollbary_draglocaly =
              mousey - scrollbary.offset().top + cthis.offset().top;
            if (o.type == 'scrollTop') {
              scrollbary_draglocaly =
                mousey - scrollbary.offset().top + $(window).scrollTop();
            }
            return false;
          });
        ...
        if (scrollbarx == undefined && dir_hor) {
          ...
          scrollbarx.mousedown(function(event) {
            ...
            scrollbarx_draglocalx =
              mousex - scrollbarx.offset().left + cthis.offset().left;
            return false;
          });
      ...
      if (
        o.settings_scrollbyhover != 'on' &&
        (cthis.hasClass('is-touch') == false ||
          o.settings_disableSpecialIosFeatures == 'on')
      ) {
        if (o.type == 'scrollTop') {
          if ($(window)[0].addEventListener) {
            $(window)[0].addEventListener(
              'DOMMouseScroll',
              handle_wheel,
              false
            );
        ...
        if (o.secondCon) {
          if (o.secondCon[0].addEventListener) {
            o.secondCon[0].addEventListener(
              'DOMMouseScroll',
              handle_wheel,
              false
            );
      ...
      function handle_wheel(e) {
        ...
        if (
          the_event &&
          the_event.target &&
          cthis.has($(the_event.target)).length < 1
        ) {
          //return;
        }
        ...
        if (
          cthis.get(0) == _t.get(0) ||
          (o.secondCon && o.secondCon.get(0) == _t.get(0))
        ) {
          if (dir_ver) {
          ...
          if (dir_hor) {
            ...
            scrollIndexX =
              viewIndexX /
              (comWidth - totalWidth_for_scrollbar) *
              -(totalWidth_for_scrollbar - scrollbarx_psize);
      ...
      function return_delta(e) {
        ...
        if (
          ...
          e.originalEvent.detail != undefined
        ) {
      ...
      if (
        ...
        $(document).mousemove(function(e) {
          ...
          if (
            ...
            (mousex < 0 ||
              mousey < 0 ||
              mousex > totalWidth + 20 ||
              mousey > totalHeight + 20)
          ) {
            return;
          }
          if (
            dir_ver == true &&
            (scrollbary_pressed == true || o.settings_scrollbyhover == 'on')
          ) {
            _scrollbar.addClass('dragging');
            cthis.addClass('dragging');
            if (o.settings_dragmethod == 'normal') {
              scrollIndexY =
                mousey / totalHeight * (totalHeight - scrollbary_psize);
          ...
          if (
            dir_hor == true &&
            (scrollbarx_pressed == true || o.settings_scrollbyhover == 'on')
          ) {
            _scrollbar.addClass('dragging');
            cthis.addClass('dragging');
            ...
            if (o.settings_dragmethod == 'normal') {
              scrollIndexX =
                mousex / totalWidth * (totalWidth - scrollbarx_psize);
              viewIndexX = mousex / totalWidth * (totalWidth - comWidth);
              if (o.secondCon != null) {
                secondCon_viX =
                  mousex / secondCon_tw * (secondCon_tw - secondCon_cw);
              }
            }
            if (o.settings_dragmethod == 'drag') {
              scrollIndexX =
                scrollbarx_dragx +
                (mousex - scrollbarx_dragx) -
                scrollbarx_draglocalx;
              viewIndexX =
                scrollIndexX /
                -(totalWidth - scrollbarx_psize) *
                (comWidth - totalWidth);
              ...
              if (o.secondCon != null) {
                ...
                secondCon_viX =
                  scrollIndexX /
                  -(secondCon_tw - scrollbarx_psize) *
                  (secondCon_cw - secondCon_tw);
              }
            }
            //console.info('animateScrollbar from handle_frame()');
            animateScrollbar();
      ...
      function animateScrollbar(pargs) {
        ...
        if (margs.do_not_clear_suspend_enter_frame == 'off') {
          suspend_enter_frame = false;
          clearTimeout(inter_suspend_enter_frame);
          inter_suspend_enter_frame = setTimeout(
            suspend_enter_frame_func,
            1000
          );
        }
      ...
      if (
        o.settings_fadeoutonleave == 'on' &&
        (is_ios() == false || o.settings_disableSpecialIosFeatures == 'on')
      ) {
      ...
      function ios_handle_frame() {
        ...
        if (inner_dragging) {
          ...
          scrollIndexX =
            -cthis_touch_left /
            cthis_touch_comwidth *
            (totalWidth - scrollbarx_psize);
          scrollIndexY =
            -cthis_touch_top /
            cthis_touch_comheight *
            (totalHeight - scrollbarx_psize);
