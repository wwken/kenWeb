...
(function($) {
  $.fn.dzsparallaxer = function(o) {
    ...
    var simple_parallaxer_max_offset = parseInt(
      o.settings_mode_oneelement_max_offset,
      10
    );
    ...
    this.each(function() {
      ...
      function init() {
        ...
        if (cthis.attr('data-responsive-reference-width')) {
          responsive_reference_width = Number(
            cthis.attr('data-responsive-reference-width')
          );
        }
        if (cthis.attr('data-responsive-optimal-height')) {
          responsive_optimal_height = Number(
            cthis.attr('data-responsive-optimal-height')
          );
        }
        ...
        if (cthis.get(0)) {
          cthis.get(0).api_set_scrollTop_is_another_element_top = function(
            arg
          ) {
        ...
        if (
          cthis.find('.divimage').length > 0 ||
          cthis.find('img').length > 0
        ) {
      ...
      function calculate_dims() {
        ...
        if (
          cthis.hasClass('allbody') == false &&
          cthis.hasClass('dzsparallaxer---window-height') == false &&
          ...
          if (th <= initialheight && th > 0) {
            if (
              ...
              cthis.hasClass('do-not-set-js-height') == false &&
              cthis.hasClass('height-is-based-on-content') == false
            ) {
              cthis.height(th);
            }
            ch = cthis.height();
        ...
        if (_theTarget.attr('data-forcewidth_ratio')) {
          _theTarget.width(
            Number(_theTarget.attr('data-forcewidth_ratio')) *
              _theTarget.height()
          );
      ...
      function handle_scroll(e, pargs) {
        ...
        if (
          (cthis_ot > st - wh && st < cthis_ot + cthis.outerHeight()) ||
        ...
        if (o.settings_mode == 'scroll') {
          if (o.mode_scroll == 'fromtop') {
            ...
            if (o.is_fullscreen == 'on') {
              ...
              if (_scrollTop_is_another_element_top) {
                vi_y =
                  st /
                  (_scrollTop_is_another_element_top.height() - wh) *
                  (ch - th);
              }
            }
            ...
            if (o.direction == 'reverse') {
              ...
              if (o.is_fullscreen == 'on') {
                ...
                if (_scrollTop_is_another_element_top) {
                  vi_y =
                    (1 -
                      st / (_scrollTop_is_another_element_top.height() - wh)) *
                    (ch - th);
          ...
          if (_scrollTop_is_another_element_top) {
            cthis_ot = -parseInt(
              _scrollTop_is_another_element_top.css('top'),
              10
            );
          }
          ...
          if (o.is_fullscreen == 'on') {
            ...
            if (_scrollTop_is_another_element_top) {
              auxer5 =
                st / (_scrollTop_is_another_element_top.outerHeight() - wh);
          ...
          if (duration_viy === 0) {
            ...
            if (sw_suspend_functional == false || 0) {
              ...
              if (cthis.hasClass('simple-parallax')) {
                if (
                  _theTarget.parent().hasClass('is-image') ||
                  cthis.hasClass('simple-parallax--is-only-image')
                ) {
