    ...
    $.data(e, 'flexslider', a),
      ...
      (a.getTarget = function(e) {
        return (
          (a.direction = e),
          'next' === e
            ? a.currentSlide === a.last ? 0 : a.currentSlide + 1
            : 0 === a.currentSlide ? a.last : a.currentSlide - 1
        );
      }),
                ...
                return 'setTouch' === t
                  ...
                  : d && a.animatingTo === a.last
                    ...
                    : d
                      ? a.limit -
                        (a.itemW + a.vars.itemMargin) * a.move * a.animatingTo
                      : a.animatingTo === a.last ? a.limit : n;
              switch (t) {
                case 'setTotal':
                  return d
            ...
            ? ((a.itemT = a.vars.itemWidth + t),
              ...
              (a.itemW =
                a.minW > a.w
                  ...
                  : a.maxW < a.w
                    ? (a.w - t * (i - 1)) / i
                    : a.vars.itemWidth > a.w ? a.w : a.vars.itemWidth),
      ...
      (a.addSlide = function(e, t) {
        ...
        (a.count += 1),
          ...
          c && d
            ...
            : void 0 !== t ? a.slides.eq(t).before(n) : a.container.append(n),
          a.update(t, 'add'),
      ...
      (a.removeSlide = function(e) {
        ...
        (a.count -= 1),
          ...
          isNaN(e)
            ? $(e, a.slides).remove()
            : c && d ? a.slides.eq(a.last).remove() : a.slides.eq(e).remove(),
          a.doMath(),
          a.update(t, 'remove'),
          (a.slides = $(a.vars.selector + ':not(.clone)', a)),
          a.setup(),
