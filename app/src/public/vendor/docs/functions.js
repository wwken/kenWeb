...
(function($) {
  ...
  EXPRESS.initialize = {
    init: function() {
      ...
      EXPRESS.initialize.imagePreload(
      ...
      if ($commonHeightEl.length > 0) {
        ...
        $commonHeightEl.each(function() {
          ...
          if (element.find('.common-height').length > 0) {
            EXPRESS.initialize.commonHeight(
  ...
  EXPRESS.header = {
      ...
      $(
        ...
        onShow: function() {
          ...
          if (
            ...
            if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
              setTimeout(function() {
                EXPRESS.initialize.commonHeight(megaMenuContent);
              }, 200);
            } else {
    ...
    onepageScroller: function() {
      $onePageMenuEl.find('li').removeClass('current');
      $onePageMenuEl
        .find('a[data-href="#' + EXPRESS.header.onePageCurrentSection() + '"]')
        .parent('li')
        .addClass('current');
    },
        ...
        if (parallaxElHeight + parallaxOffsetTop + 50 > $window.scrollTop()) {
          ...
          if ($window.scrollTop() > parallaxOffsetTop) {
            if ($sliderParallaxEl.find('.slider-parallax-inner').length > 0) {
              var tranformAmount = (($window.scrollTop() - parallaxOffsetTop) *
                  -0.4).toFixed(0),
                tranformAmount2 = (($window.scrollTop() - parallaxOffsetTop) *
                  -0.15).toFixed(0);
              $sliderParallaxEl
                .find('.slider-parallax-inner')
  ...
  EXPRESS.widget = {
    ...
    linkScroll: function() {
      $('a[data-scrollto]').click(function() {
        ...
        if (!divScrollOffset) {
          divScrollOffset = EXPRESS.initialize.topScrollOffset();
        }
        if (!divScrollEasing) {
  ...
  EXPRESS.isMobile = {
    ...
    any: function() {
      return (
        EXPRESS.isMobile.Android() ||
        EXPRESS.isMobile.BlackBerry() ||
        EXPRESS.isMobile.iOS() ||
        EXPRESS.isMobile.Opera() ||
        EXPRESS.isMobile.Windows()
      );
    },
  };
