  ...
  var styleSwitcher = {
      ...
      if (((a.basePath = c), !this.initialized)) {
        if (
          ...
          null != $.cookie('borderRadius') &&
            (a.options.borderRadius = $.cookie('borderRadius')),
          null != $.cookie('colorPrimary') &&
            (a.options.colorPrimary = '#' + $.cookie('colorPrimary')),
          null != $.cookie('colorAlternateBG') &&
            (a.options.colorAlternateBG = '#' + $.cookie('colorAlternateBG')),
          null != $.cookie('colorMainBG') &&
            (a.options.colorMainBG = '#' + $.cookie('colorMainBG')),
          null != $.cookie('colorBorder') &&
            (a.options.colorBorder = '#' + $.cookie('colorBorder')),
          null != $.cookie('menuFontSize') &&
            (a.options.menuFontSize = $.cookie('menuFontSize')),
          null != $.cookie('bodyFontSize') &&
            (a.options.bodyFontSize = $.cookie('bodyFontSize')),
          null != $.cookie('bodyLineHeight') &&
            (a.options.bodyLineHeight = $.cookie('bodyLineHeight')),
          null != $.cookie('menuDropdownFontSize') &&
            (a.options.menuDropdownFontSize = $.cookie('menuDropdownFontSize')),
          null != $.cookie('menuTextTransform') &&
            (a.options.menuTextTransform = $.cookie('menuTextTransform')),
          null != $.cookie('headingsTextTransform') &&
            (a.options.headingsTextTransform = $.cookie(
              'headingsTextTransform'
            )),
          b &&
            ((b = b.replace(/'/g, '"')),
          ...
          d.append(
            $('<link rel="stylesheet">').attr(
              'href',
              c + 'vendor/style-switcher/style-switcher.css'
            )
          ),
          null == $.cookie('showSwitcher') &&
            !a.options.showSwitcher &&
            $.cookie('initialized'))
        )
        ...
        d.append($('<link rel="stylesheet/less">').attr('href', e)),
          d.append(
            $('<link rel="stylesheet">').attr(
              'href',
              c +
                'vendor/style-switcher/bootstrap-colorpicker/css/bootstrap-colorpicker.css'
            )
          ),
          $.styleSwitcherCachedScript(
            c +
              'vendor/style-switcher/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js'
          ).done(function(d, e) {
            (less = {
              async: !0,
              env: 'production',
              ...
              $.styleSwitcherCachedScript(
                c + 'vendor/style-switcher/less.js'
              ).done(function(d, e) {
                $.ajax({
                  ...
                  $('body').append(c),
                    ...
                    'img/logo.png' !=
                      ...
                      (a.options.changeLogo = !1),
                    b ||
                      (null != $.cookie('layoutStyle') &&
                        (a.options.layoutStyle = $.cookie('layoutStyle')),
                      null != $.cookie('menuDrapdownColor') &&
                        (a.options.menuDrapdownColor = $.cookie(
                          'menuDrapdownColor'
                        )),
                      $('body').hasClass('one-page') &&
                        (a.options.websiteType = 'one-page'),
                      null != $.cookie('backgroundColor') &&
                        (a.options.backgroundColor = $.cookie(
                          'backgroundColor'
                        )),
                      null != $.cookie('backgroundPattern') &&
                        (a.options.backgroundPattern = $.cookie(
                          'backgroundPattern'
                        ))),
                    ...
                    $('.xmenu-dropdown-color').val(
                      $.cookie('menuDrapdownColor')
                    ),
                    $('.menu-font-size').val($.cookie('menuFontSize')),
                    $('.body-font-size').val($.cookie('bodyFontSize')),
                    $('.menu-dropdown-font-size').val(
                      $.cookie('menuDropdownFontSize')
                    ),
                    $('.menu-text-transform').val(
                      $.cookie('menuTextTransform')
                    ),
                    $('.headings-text-transform').val(
                      $.cookie('headingsTextTransform')
                    );
                });
              });
          }),
          $.styleSwitcherCachedScript(
            c + 'vendor/style-switcher/cssbeautify/cssbeautify.js'
          ).done(function(a, b) {});
      }
    },
    ...
    initializeSimpleMode: function() {
      var a = this,
        ...
        d =
          '<div id="styleSwitcherSimple" class="style-switcher style-switcher-simple hidden-xs"><a id="styleSwitcherSimpleOpen" class="style-switcher-open" href="#"><i class="fa fa-cogs"></i></a></div>';
      $('body').append(d),
        'img/logo.png' == c,
    ...
    build: function() {
      ...
      b
        .val(a.options.colorPrimary)
        .parent()
        .colorpicker(),
        c
          .val(a.options.colorAlternateBG)
          .parent()
          .colorpicker(),
        d
          .val(a.options.colorMainBG)
          .parent()
          .colorpicker(),
        e
          .val(a.options.colorBorder)
          .parent()
          .colorpicker(),
        $('.colorpicker')
        ...
        this.container
          .find('.menu-dropdown-font-size')
          .on('change', function() {
            a.setMenuDropdownFontSize(
              $(this)
                .find(':selected')
                .val()
            );
        ...
        this.container
          .find('.headings-text-transform')
          .on('change', function() {
            a.setHeadingsTextTransform(
              $(this)
                .find(':selected')
                .val()
            );
    ...
    setColors: function(a, b) {
      ...
      return this.isChanging
        ? !1
        : (a &&
            ((c.options['color' + b.capitalize()] = a),
    ...
    setLayoutStyle: function(a, b) {
      ...
      if (
        (c.options.preserveCookies || $.cookie('layoutStyle', a),
    ...
    setMenuDrapdownColor: function(a, b) {
      var c = this;
      if (
        (c.options.preserveCookies || $.cookie('menuDrapdownColor', a),
        this.options.saveToStorage &&
          'undefined' != typeof localStorage &&
          localStorage.setItem('menuDrapdownColor', a),
        b)
      )
        return $.cookie('showSwitcher', !0), window.location.reload(), !1;
    ...
    setWebsiteType: function(a) {
      ...
      'one-page' == a
        ? (b.find('a:last').addClass('active'), c.prev().remove(), c.remove())
    ...
    setBackgroundPattern: function(a) {
      ...
      if ('' == a) return this;
      var c =
        $('html').hasClass('boxed-layout') ||
        $('html').hasClass('boxed-layout-2');
