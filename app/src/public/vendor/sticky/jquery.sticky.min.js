    ...
    i = function() {
      for (
        ...
        var l = g[j],
          ...
          n = m - l.topSpacing - i;
        if (
          (l.stickyWrapper.css('height', l.stickyElement.outerHeight()), b <= n)
        )
          null !== l.currentTop &&
            (l.stickyElement.css({
              width: '',
          ...
          var o =
            ...
            i;
          if (
            (o < 0 ? (o += l.topSpacing) : (o = l.topSpacing),
            l.currentTop !== o)
          ) {
            var p;
            l.getWidthFrom
      ...
      setupChangeListeners: function(a) {
        if (window.MutationObserver) {
          ...
          window.addEventListener
            ...
            : window.attachEvent &&
              (a.attachEvent('onDOMNodeInserted', function() {
                k.setWrapperHeight(a);
              }),
