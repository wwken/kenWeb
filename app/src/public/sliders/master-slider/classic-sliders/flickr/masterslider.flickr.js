  ...
  p._photosData = function(data) {
    ...
    $.each(data[this.options.type].photo, function(i, item) {
      ...
      if (that.options.title)
        slide_cont +=
          '<div class="ms-layer ms-fkr-title" data-effect="' +
          that.options.titleEff +
          '" data-duration = "1000"  data-ease = "easeOutQuad"  data-type = "text">' +
          title +
          '</div>';
      ...
      if (getInfo) {
        ...
        $.getJSON(getImgInfoURL(that.options.key, item.id), function(data) {
          if (that.options.desc)
            $('#slide-' + i).append(
              '<div class="ms-layer ms-fkr-desc" data-effect="' +
                that.options.descEff +
                '" data-duration = "1000"  data-ease = "easeOutQuad"  data-type = "text">' +
          ...
          that.count--;
          if (that.count === 0) that._initSlider();
        });
      }
