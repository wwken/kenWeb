    ...
    (p.setStartAnim = function(anim) {
      ...
      (p.create = function() {
        ...
        (this.parallax = this.$element.data('parallax')),
          null != this.parallax &&
            ((this.parallax /= 100),
            (this.$parallaxElement = $('<div></div>').addClass(
              'ms-parallax-layer'
            )),
            this.masked
  ...
  (function($) {
    ...
    (p.setupView = function() {
      ...
      (p.showLayers = function(layerIds, delay) {
        var self = this;
        $.each(layerIds.replace(/\s+/g, '').split('|'), function(
          index,
          layerId
        ) {
          ...
          layers.each(function(index, domEle) {
            ...
            void 0 !== $layer_element.data('effect') &&
              ...
              void 0 !== $layer_element.data('hide-duration') &&
                (end_eff_parameters.duration = $layer_element.data(
                  'hide-duration'
                )),
  ...
  (function($) {
    ...
    window.MSFlickrV2 = function(slider, options) {
      ...
      'photoset' === this.options.type
        ...
        (this.slideTemplate = this.slider.$element.find(
          '.ms-slide'
        )[0].outerHTML),
