          ...
          (function(o) {
              ...
              if (
                ...
                k(d, t.negativeSignCharacter) &&
                  ...
                  '' !== n &&
                    ...
                    '0' === d.charAt(0) &&
                    (d = d.slice(1)),
                  (e = '' + n + d + (a(u) ? '' : t.decimalCharacter + u));
              }
              return (
            ...
            function ie(e, i) {
                ...
                if (n)
                  switch (i.negativePositiveSignPlacement) {
                    ...
                    case 'r':
                      ...
                      break;
                    case 's':
                      (e = '' + i.currencySymbol + e + i.negativeSignCharacter),
              ...
              if ('s' === i.currencySymbolPlacement)
                if (n)
                  switch (i.negativePositiveSignPlacement) {
                    case 'r':
                      (e = '' + e + i.currencySymbol + i.negativeSignCharacter),
                        (i.trailingNegative = !0);
                      break;
                    case 'l':
                      (e = '' + e + i.negativeSignCharacter + i.currencySymbol),
                        (i.trailingNegative = !0);
                      break;
                    case 'p':
            ...
            function ne(e, t) {
              ...
              var i = '',
                ...
                n = '',
                o = void 0;
              (o = t.allowDecimalPadding ? t.decimalPlacesOverride : 0),
                M(e) && ((n = '-'), (e = e.replace('-', ''))),
                e.match(/^\d/) || (e = '0' + e),
                0 === Number(e) && (n = ''),
                ((Number(e) > 0 && 'keep' !== t.leadingZero) ||
                  (e.length > 0 && 'allow' === t.leadingZero)) &&
                  (e = e.replace(/^0*(\d)/, '$1'));
              var l = e.lastIndexOf('.'),
                s = l === -1,
                c = s ? e.length - 1 : l,
                ...
                return (
                  e.each(v, function(t, a) {
                    ...
                    if (i > -1 && o[i] > -1) {
                      ...
                      'object' ===
                        ('undefined' == typeof s ? 'undefined' : c(s)) &&
                  ...
                  : i.scaleDivisor
                    ...
                    : i.noSeparatorOnFocus
                      ? ((i.digitGroupSeparator = ''),
                        ...
                        (n = ne(i.rawValue, i)),
                        e.val(ie(n, i)))
                      : r !== i.rawValue && e.autoNumeric('set', r),
                    ...
                    e._skipAlways(t)
                      ...
                      : e.eventKeyCode === y.Backspace ||
                        ...
                        ? (e._processCharacterDeletion(),
                          ...
                          void (e.settingsClone.throwInput = !0))
                        : void (e.formatted = !1))
              );
            }
            function Pe(e, t) {
            ...
            function Ce(e, t) {
              ...
              if (
                ...
                if (
                  ...
                  (t.target.value = e.lastVal),
                    Z(t.target, e.selection.start, e.selection.end),
                    (e.settings.androidSelectionStart = e.selection.start),
                    t.preventDefault(),
                    (e.formatted = !1);
            ...
            function Oe(e, t, a) {
              if (!e.is(':focus')) {
                ...
                null === d && (d = ie(i, n)),
                  d !== r &&
                    ((d = n.scaleSymbol ? d + n.scaleSymbol : d), e.val(d)),
                  d !== t.valueOnFocus && (e.change(), delete t.valueOnFocus);
              }
            }
            function xe(e, t, a) {
              a.preventDefault();
              ...
              if (
                ...
                return void (
                  ...
                  z(
                    "The pasted value '" + i + "' is not a valid paste content."
                  )
                );
              var m = void 0,
                g = void 0;
                ...
                case 'replace':
                  ...
                  for (
                    var C = le(t.settings.minimumValue),
                      O = le(t.settings.maximumValue),
                      x = p,
                      V = 0,
                      A = y;
                    V < d.length && ((A += d[V]), (p = A + S), B(p, C, O));
                  ...
                  for (var F = m, T = x.length; V < d.length && F < T; )
                    if ('.' !== x[F]) {
                      if (((p = _(x, F, d[V])), !B(p, C, O))) break;
                      (x = p), V++, F++;
                    } else F++;
                  (m = F), f && m--, (p = x);
                  break;
              ...
              if (q)
                switch (t.settings.onInvalidPaste) {
                  ...
                  case 'replace':
                  default:
                    (J = U(p, m, a.target.value, t.settings.decimalCharacter)),
                      Z(a.target, J);
                }
            ...
            function Ve(e) {
              ...
              return (
                'input' === a ||
                  V(a, p) ||
                  z('The <' + a + '> tag is not supported by autoNumeric'),
                t
              );
            }
            function Ae(e, t, a) {
            ...
            function De(e) {
              t(e.decimalPlacesOverride) &&
                (e.decimalPlacesOverride = W(e.minimumValue, e.maximumValue)),
                (e.oDec = String(e.decimalPlacesOverride)),
                (e.decimalPlacesOverride = Number(e.decimalPlacesOverride));
            }
            function Be(e) {
            ...
            function Le(e) {
              ...
              (e.allowedAutoStrip = new RegExp('[^' + n + ']', 'g')),
            ...
            function Ie(i, r) {
              ...
              if (((!n && t(i)) || Ee(i), n || a(o))) {
                ...
                return (
                  Me(o),
                  Fe(o),
                  (o.negativeSignCharacter = o.minimumValue < 0 ? '-' : ''),
                  (o.positiveSignCharacter = o.maximumValue >= 0 ? '+' : ''),
                  q(r, o),
                  Te(o),
                  De(o),
                  Be(o),
                      ...
                      value: function() {
                        ...
                        return (
                          this.eventKeyCode === y.Hyphen &&
                            0 === Number(i) &&
                            (n = !1),
                          (i = Q(i, this.settingsClone, n)),
                          (r = Q(r, this.settingsClone, !1)),
                          e.trailingNegative &&
                            !L(i) &&
                            ((i = '-' + i),
                            (r = '-' === r ? '' : r),
                      ...
                      value: function(e, t) {
                        ...
                        if (((this.newValue = r.join('')), l && c)) {
                          ...
                          var d = k(this.newValue, ',')
                            ...
                            : this.newValue;
                          return (
                            '' === d || d === i.negativeSignCharacter
                              ? (i.rawValue =
                                  'zero' === i.emptyInputBehavior ? '0' : '')
                              : (i.rawValue = ve(d, i)),
                            u > this.newValue.length &&
                              (u = this.newValue.length),
                            1 === u &&
                              '0' === r[0] &&
                              'deny' === i.leadingZero &&
                      ...
                      value: function(t) {
                        ...
                        (g === this.that.value &&
                          (g !== this.that.value ||
                            (this.eventKeyCode !== y.num0 &&
                              this.eventKeyCode !== y.numpad0))) ||
                          ((this.that.value = g), this._setCaretPosition(h)),
                          null !== i.androidSelectionStart &&
                            this._setCaretPosition(i.androidSelectionStart),
                          (this.formatted = !0);
                      },
                    },
                  ]),
              ...
              je = {
                init: function(a) {
                  return this.each(function() {
                    ...
                    if (t(n)) return this;
                    var o = de(i, n, !1);
                    !n.runOnce && n.formatOnPageLoad && Ae(n, r, i),
                      (n.runOnce = !0),
                      r &&
                    ...
                    if (null !== t && !a(t)) {
                      ...
                      if ((m && (n = '0'), !u || !d)) {
                        ...
                        return (
                          ...
                          d || e.trigger('autoNumeric:maxExceeded'),
                          z(
                            'The value [' +
                              g +
                      ...
                      return (
                        i.saveValueToSessionStorage &&
                          ...
                          fe(e[0], i, 'set'),
                        !i.hasFocus && i.scaleSymbol && (n += i.scaleSymbol),
                        r
                          ? e.val(n)
                ...
                get: function() {
                  ...
                  if (
                    ...
                    '' !== i &&
                      ...
                      (a.runOnce || a.formatOnPageLoad === !1) &&
                        ((i = Q(i, a, !0)),
                ...
                getLocalized: function() {
                  var e = ue(this),
                    ...
                    a = e.data('autoNumeric');
                  return (
                    0 === Number(t) && 'keep' !== a.leadingZero && (t = '0'),
                    X(t, a.outputFormat)
                  );
                },
                getNumber: function() {
                ...
                getFormatted: function() {
                  return (
                    (this.hasOwnProperty('0') && 'value' in this[0]) ||
                      z('Unable to get the formatted string from the element.'),
                    this[0].value
                  );
                },
                getString: function() {
                ...
                return (
                  ...
                  L(t)
                    ...
                    : r.negativeBracketsTypeOnBlur &&
                      r.negativeBracketsTypeOnBlur.split(',')[0] ===
                        t.charAt(0) &&
                      ((r.negativeSignCharacter = '-'),
                      (r.hasFocus = !0),
                      (t = J(t, r))),
