...
!(function(a) {
    ...
    for (var g = [], h = 0; h < b.length; h++) {
      ...
      if (i) {
        ...
        var l = j.toString(e.preferredFormat || 'rgb'),
          m = f
            ? 'background-color:' + j.toRgbString()
            : 'filter:' + j.toFilter();
        g.push(
          '<span title="' +
            l +
  ...
  function l(c, l) {
    function xa() {
      if (
        (n.showPaletteOnly && (n.showPalette = !0),
        ka.text(
          n.showPaletteOnly ? n.togglePaletteMoreText : n.togglePaletteLessText
        ),
        n.palette)
      ) {
    ...
    function ya() {
        ...
        return (
          b.data && b.data.ignore
            ...
            : (Na(
              ...
              Qa(),
              n.hideAfterPaletteSelect ? (Ta(!0), La()) : Ta()),
          !1
        );
      }
      if (
      ...
      za(),
        pa.on('click.spectrum touchstart.spectrum', function(b) {
          W || Ha(),
            b.stopPropagation(),
            a(b.target).is('input') || b.preventDefault();
        }),
        (V.is(':disabled') || !0 === n.disabled) && Ya(),
        X.click(o),
        ea.change(Ga),
        ea.on('paste', function() {
          setTimeout(Ga, 1);
        }),
        ...
        ha.on('click.spectrum', function(a) {
          a.stopPropagation(), a.preventDefault(), Ma(), La();
        }),
        ia.attr('title', n.clearText),
        ia.on('click.spectrum', function(a) {
          a.stopPropagation(), a.preventDefault(), (va = !0), Qa(), p && Ta(!0);
        }),
        ja.text(n.chooseText),
        ja.on('click.spectrum', function(a) {
          a.stopPropagation(),
            a.preventDefault(),
        ...
        ka.on('click.spectrum', function(a) {
          a.stopPropagation(),
            a.preventDefault(),
        ...
        ra
          ? (Na(ra),
            Ra(),
            (ta = n.preferredFormat || tinycolor(ra).format),
            Aa(ra))
          : Ra(),
        p && Ia();
      var d = e ? 'mousedown.spectrum' : 'click.spectrum touchstart.spectrum';
      fa.on(d, '.sp-thumb-el', c),
        ga.on(d, '.sp-thumb-el:nth-child(1)', { ignore: !0 }, c);
    }
    function za() {
    ...
    function Aa(b) {
      if (t) {
        ...
        if (!O[c] && -1 === a.inArray(c, P))
          for (P.push(c); P.length > Q; ) P.shift();
        if (u && window.localStorage)
          try {
    ...
    function Ga() {
      ...
      if ((null !== a && '' !== a) || !wa) {
        var b = tinycolor(a);
        b.isValid() ? (Na(b), Qa(), Ta()) : ea.addClass('sp-validation-error');
      } else Na(null), Qa(), Ta();
    }
    function Ha() {
      y ? La() : Ia();
    ...
    function Ia() {
      ...
      V.trigger(b, [Oa()]),
        !1 === w.beforeShow(Oa()) ||
          ...
          (j(),
          (y = !0),
          a(T).on('keydown.spectrum', Ja),
          a(T).on('click.spectrum', Ka),
          a(window).on('resize.spectrum', x),
    ...
    function Ka(a) {
      2 != a.button && (z || (ua ? Ta(!0) : Ma(), La()));
    }
    function La() {
      y &&
        !p &&
        ((y = !1),
        a(T).off('keydown.spectrum', Ja),
        a(T).off('click.spectrum', Ka),
        a(window).off('resize.spectrum', x),
        oa.removeClass('sp-active'),
    ...
    function Na(a, b) {
      if (tinycolor.equals(a, Oa())) return void Ra();
      var c, d;
      !a && wa
        ? (va = !0)
        : ((va = !1),
    ...
    function Oa(a) {
      return (
        ...
        wa && va
          ? null
          : tinycolor.fromRatio(
              { h: I, s: J, v: K, a: Math.round(1e3 * L) / 1e3 },
              { format: a.format || ta }
            )
      );
    }
    ...
    function Qa() {
      Ra(), w.move(Oa()), V.trigger('move.spectrum', [Oa()]);
    }
    function Ra() {
      ...
      if (
        ...
        if (
          ...
          e
            ? ba.css('filter', tinycolor(j).toFilter({ gradientType: 1 }, g))
    ...
    function Va() {
      V.show(),
        pa.off('click.spectrum touchstart.spectrum'),
        X.remove(),
        oa.remove(),
        (d[$a.id] = null);
    }
    ...
    var n = k(l, c),
      ...
      _ = X.find('.sp-hue'),
      aa = X.find('.sp-slider'),
      ba = X.find('.sp-alpha-inner'),
      ca = X.find('.sp-alpha'),
      da = X.find('.sp-alpha-handle'),
      ea = X.find('.sp-input'),
      fa = X.find('.sp-palette'),
      ga = X.find('.sp-initial'),
      ha = X.find('.sp-cancel'),
      ia = X.find('.sp-clear'),
      ja = X.find('.sp-choose'),
      ka = X.find('.sp-palette-toggle'),
      la = V.is('input'),
      ma = la && 'color' === V.attr('type') && s(),
      na = la && !p,
      oa = na
        ? a(g)
            .addClass(v)
      ...
      ra = n.color || (la && V.val()),
      sa = !1,
      ta = n.preferredFormat,
      ua = !n.showButtons || n.clickoutFiresChange,
      va = !ra,
      wa = n.allowEmpty && !ma;
    ya();
    var $a = {
  ...
  function m(b, c) {
    ...
    return (
      (n += g),
      (m -= Math.min(m, m + e > j && j > e ? Math.abs(m + e - j) : 0)),
      (n -= Math.min(n, n + f > k && k > f ? Math.abs(f + g - d) : d)),
      {
        top: n,
        bottom: l.bottom,
        left: m,
  ...
  function q(b, c, d, f) {
    ...
    function p(c) {
      (c.which ? 3 == c.which : 2 == c.button) ||
        h ||
        (!1 !== d.apply(b, arguments) &&
          ((h = !0),
          (j = a(b).height()),
          (k = a(b).width()),
          (i = a(b).offset()),
          a(g).on(m),
          a(g.body).addClass('sp-dragging'),
          o(c),
          n(c)));
    }
    function q() {
      h &&
        (a(g).off(m),
        a(g.body).removeClass('sp-dragging'),
        setTimeout(function() {
          f.apply(b, arguments);
        }, 0)),
        (h = !1);
  ...
  (a.fn.spectrum = function(b, c) {
    ...
    (a.fn.spectrum.inputTypeColorSupport = function b() {
      if (void 0 === b._cachedResult) {
    ...
    (function() {
      ...
      function l(a, b, c) {
        ...
        if (d == e) h = i = 0;
          ...
          var k = d - e;
          switch (((i = j > 0.5 ? k / (2 - d - e) : k / (d + e)), d)) {
            case a:
              h = (b - c) / k + (b < c ? 6 : 0);
              break;
            case b:
      ...
      function v(a, b) {
        ...
        var c = i(a).toRgb();
        return (
          (c.r = g(0, f(255, c.r - e(-b / 100 * 255)))),
          (c.g = g(0, f(255, c.g - e(-b / 100 * 255)))),
          (c.b = g(0, f(255, c.b - e(-b / 100 * 255)))),
          i(c)
        );
      }
      function w(a, b) {
      ...
      function D(a, b) {
        b = b || 6;
        for (
          var c = i(a).toHsv(), d = c.h, e = c.s, f = c.v, g = [], h = 1 / b;
          b--;
      ...
      var a = /^[\s,#]+/,
        ...
        h = d.random,
        i = function(a, b) {
          if (((a = a || ''), (b = b || {}), a instanceof i)) return a;
          ...
          (this._originalInput = a),
            ...
            (this._b = d.b),
            (this._a = d.a),
            (this._roundA = e(1e3 * this._a) / 1e3),
      ...
      (i.prototype = {
        ...
        setAlpha: function(a) {
          return (
            (this._a = H(a)), (this._roundA = e(1e3 * this._a) / 1e3), this
          );
        },
        toHsv: function() {
        ...
        toName: function() {
          return 0 === this._a
            ? 'transparent'
            : !(this._a < 1) && (F[p(this._r, this._g, this._b, !0)] || !1);
        },
        toFilter: function(a) {
        ...
        (i.equals = function(a, b) {
          return !(!a || !b) && i(a).toRgbString() == i(b).toRgbString();
        }),
        (i.random = function() {
        ...
        (i.mostReadable = function(a, b) {
          for (var c = null, d = 0, e = !1, f = 0; f < b.length; f++) {
            var g = i.readability(a, b[f]),
              ...
              j = g.brightness / 125 * 3 + g.color / 500;
            ((h && !e) || (h && e && j > d) || (!h && !e && j > d)) &&
              ((e = h), (d = j), (c = i(b[f])));
          }
          return c;
