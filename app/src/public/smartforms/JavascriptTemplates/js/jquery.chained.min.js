...
!(function(a) {
  ...
  (a.fn.remoteChained = function(b) {
        ...
        a(c.parents).each(function() {
          a(this).bind('change', function() {
            ...
            a(c.parents).each(function() {
              ...
              e && a.isFunction(e.abort) && (e.abort(), (e = !1)),
              c.clear &&
                (c.loading
                  ? b.call(d, { '': c.loading })
                  : a('option', d).remove(),
                a(d).trigger('change')),
              (e = a.getJSON(c.url, f, function(c) {
    ...
    (a.fn.remoteChainedTo = a.fn.remoteChained),
    (a.fn.remoteChained.defaults = {
      attribute: 'name',
      depends: null,
      bootstrap: null,
      loading: null,
