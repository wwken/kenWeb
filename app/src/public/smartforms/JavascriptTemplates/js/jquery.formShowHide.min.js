...
!(function(e) {
  (e.formShowHide = function(o, n) {
    ...
    (i.$el = e(o)),
      (i.el = o),
      'undefined' == typeof i.$el.data('formShowHide') &&
        ((i.options = e.extend({}, e.formShowHide.defaultOptions, n)),
        i.$el.data('formShowHide', i),
        (i.nodeType = i.el.nodeName.toUpperCase()),
        (i.inputType =
          'INPUT' === i.nodeType ? i.$el.attr('type').toUpperCase() : ''),
        (i.showType = ''),
        (i.showParams = ''),
        (i.init = function() {
          var o =
            'change.formShowHide keyup.formShowHide check.formShowHide initCheck.formShowHide';
          if ('SELECT' === i.nodeType)
            i.$el.off('.formShowHide').on(o, i.onChange);
          else if ('OPTION' === i.nodeType)
            i.$el
              .closest('select')
              .off('.formShowHide')
              .on(o, i.onChange);
          else if ('INPUT' === i.nodeType)
            if ('RADIO' === i.inputType) {
              var n = i.$el.attr('name');
              e('input[name="' + n + '"]')
                .off('.formShowHide')
                .on(o, i.onChange);
            } else
              'CHECKBOX' === i.inputType
                ? i.$el.off('.formShowHide').on(o, i.onChange)
                : 'TEXT' === i.inputType &&
                  ((i.showType = i.$el.attr(i.options.showTypeAttr)),
                  (i.showParams = i.$el.attr(i.options.showParamsAttr)),
                  i.showType &&
                    i.showParams &&
                    (i.showParams = i.convertStrToArr(i.showParams, !0)),
                  i.$el.off('.formShowHide').on(o, i.onChange));
          ...
          if ('SELECT' === i.nodeType || 'OPTION' === i.nodeType) {
            ...
            if ('RADIO' === i.inputType) {
              ...
              e('input[name="' + r + '"]').each(function(o, t) {
                n += e(t).prop('checked')
                  ? i.checkShowDefined(e(t))
                  : ' ' + i.checkHideDefined(e(t));
              });
            } else
              'CHECKBOX' === i.inputType
                ? (n += i.$el.prop('checked')
                    ? ' ' + i.checkShowDefined(i.$el)
                    : ' ' + i.checkHideDefined(e(o)))
                : 'TEXT' === i.inputType &&
                  i.showType &&
                  i.showParams &&
                  'function' == typeof e.formShowHide.types[i.showType] &&
                  i.showParams.length > 0 &&
                  e.formShowHide.types[i.showType](i.el, i.showParams) &&
                  (n = i.checkShowDefined(i.$el));
          return 'undefined' == typeof n
            ? []
            : i.convertStrToArr(e.fn.formShowHide.utils.trim(n));
        }),
          ...
          if ('SELECT' === i.nodeType || 'OPTION' === i.nodeType) {
            ...
            if ('RADIO' === i.inputType) {
              ...
              e('input[name="' + h + '"]').each(function(o, n) {
                t += e(n).prop('checked')
                  ? ' ' + i.checkHideDefined(e(n))
                  : ' ' + i.checkShowDefined(e(n));
              });
            } else
              'CHECKBOX' === i.inputType
                ? (t += i.$el.prop('checked')
                    ? ' ' + i.checkHideDefined(e(o))
                    : ' ' + i.checkShowDefined(e(o)))
                : 'TEXT' === i.inputType &&
                  i.showType &&
                  i.showParams &&
                  'function' == typeof e.formShowHide.types[i.showType] &&
                  i.showParams.length > 0 &&
                  (e.formShowHide.types[i.showType](i.el, i.showParams) ||
                    (t = i.checkShowDefined(i.$el)));
          var f = i.convertStrToArr(e.fn.formShowHide.utils.trim(t));
          return n.length === f.length && 1 === n.length
            ? f
            : (e(n).each(function(e, o) {
        ...
        (i.onChange = function(o) {
          var n = i.idsToShow(),
            t = i.idsToHide(n);
          (n.length === t.length && e.fn.formShowHide.utils.compare(n, t)) ||
            e(n).each(function(n, t) {
              e(t).is(':visible')
                ? i.options.showAlreadyVisible(n, t)
                : 'initCheck' === o.type
                  ? i.options.initShow(n, t)
                  : i.options.show(n, t);
            }),
            e(t).each(function(n, t) {
              var r = function() {
                e(t).hasClass(i.options.resetClass) &&
                  (e(t)
                    .find('input:text')
                    .attr('value', '')
                    .trigger('keyup'),
              ...
              'initCheck' === o.type
                ? i.options.initHide(n, t, r)
                : i.options.hide(n, t, r);
            });
        }),
        i.init());
  }),
    ...
    (e.formShowHide.defaultOptions = {
      show: function(o, n, i) {
        e(n).show(), 'function' == typeof i && i();
      },
      hide: function(o, n, i) {
        e(n).hide(), 'function' == typeof i && i();
      },
    ...
    (e.fn.formShowHide.utils = {
      ...
      compare: function(e, o) {
        ...
        for (var n = e.sort(), i = o.sort(), t = 0; o[t]; t += 1)
          if (n[t] !== i[t]) return !1;
        return !0;
      },
    });
