(function(a) {
  a.fn.stepper = function(b) {
    ...
    return a(this).each(function() {
      var g = a(this).data();
      delete g.stepper;
      var m = a.extend({}, c, b, g),
        k = a(this),
        p = a('<div class="stepper-wrap"/>');
      if (k.data('stepper')) {
        return;
      }
      p.insertAfter(k);
      ...
      if (m.ui) {
        var f = a('<div class="stepper-btn-wrap"/>').appendTo(p),
          j = a(
            '<a class="stepper-btn-up">' + m.incrementButton + '</a>'
          ).appendTo(f),
          o = a(
            '<a class="stepper-btn-dwn">' + m.decrementButton + '</a>'
          ).appendTo(f);
        p.css({
      ...
      function n(q) {
        ...
        var s = m.type == 'int' ? parseInt : parseFloat,
          r = i(s(k.val()) + q);
        k.val(r);
        d('Step', [r, q > 0]);
        return r;
