...
(function($) {
  ...
  $.extend(Monthpicker.prototype, {
      ...
      if (showOn === 'button' || showOn === 'both') {
        ...
        inst.trigger.click(function() {
          if (
            ...
            $.monthpicker._lastInput === input[0]
          ) {
    ...
    _checkExternalClick: function(event) {
      ...
      if (
        ($target[0].id != $.monthpicker._mainDivId &&
    ...
    _showMonthpicker: function(input) {
      ...
      if (
        $.monthpicker._isDisabledMonthpicker(input) ||
          ...
          case 33:
            $.monthpicker._adjustDate(
              ...
              event.ctrlKey
                ...
                : -$.monthpicker._get(inst, 'stepYears'),
              'Y'
            );
            break;
          case 34:
    ...
    _adjustInstDate: function(inst, offset, period) {
      ...
      var month =
        Math.min(inst.selectedMonth, 12) + (period === 'M' ? offset : 0);
    ...
    _generateHTML: function(inst) {
      ...
      var currentDate = !inst.currentMonth
        ? new Date(9999, 9, 9)
      ...
      html +=
        ...
        prev +
        next +
        this._generateYearHeader(inst, drawYear, minDate, maxDate) +
      ...
      for (var month = 0; month <= 11; month++) {
        ...
        html +=
          '<td class="' +
          (drawYear == inst.currentYear && month == inst.currentMonth
            ? ' ' + this._currentClass
            : '') +
          (unselectable
          ...
          (drawYear == inst.currentYear && month == inst.currentMonth
            ? ' ui-state-active'
            : '') +
          (drawYear == today.getFullYear() && month == today.getMonth()
            ? ' ui-state-highlight'
            : '') +
          '" href="#">' +
          (inst.settings && inst.settings.monthNamesShort
            ? inst.settings.monthNamesShort[month]
            : this._defaults.monthNamesShort[month]) +
          '</a>' +
          '</td>';
        if (month % 3 === 2) {
          html += '</tr>';
      ...
      var gotoDate =
        this._get(inst, 'gotoCurrent') && inst.currentMonth
          ? currentDate
          : today;
    ...
    _canAdjustYear: function(inst, offset, curYear) {
      ...
      return (
        this._isInRange(inst, firstMonth) || this._isInRange(inst, lastMonth)
      );
    },
    ...
    _selectMonth: function(id, year, month, td) {
      ...
      if (
        ...
        this._isDisabledMonthpicker(target[0])
      ) {
        return;
      }
      ...
      this._selectDate(
        id,
        this._formatDate(inst, inst.currentMonth, inst.currentYear)
      );
    },
    parseDate: function(format, value, settings) {
      ...
      for (var iFormat = 0; iFormat < format.length; iFormat++) {
        if (literal)
          if (format.charAt(iFormat) == "'" && !lookAhead("'")) literal = !1;
          else checkLiteral();
        else
    ...
    _optionMonthpicker: function(target, name, value) {
      ...
      if (inst) {
        ...
        date = this._getDateMonthpicker(target, !0);
        minDate = this._getMinMaxDate(inst, 'min');
        maxDate = this._getMinMaxDate(inst, 'max');
    ...
    _formatDate: function(inst, month, year) {
      ...
      var date = month
        ? typeof month == 'object' ? month : new Date(year, month, 1)
        : new Date(inst.currentYear, inst.currentMonth, 1);
  ...
  $.fn.monthpicker = function(options) {
    ...
    if (
      ...
      return $.monthpicker['_' + options + 'Monthpicker'].apply(
        $.monthpicker,
    ...
    return this.each(function() {
      typeof options === 'string'
        ? $.monthpicker['_' + options + 'Monthpicker'].apply(
            $.monthpicker,
