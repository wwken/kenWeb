  ...
  e(document).mouseup(function() {
      ...
      start: function() {
        var t,
          ...
          c =
            d instanceof e
              ? d.get(0)
              : /parent/.test(d) ? u.parent().get(0) : d;
        c &&
    ...
    e.widget('ui.autocomplete', {
      ...
      _create: function() {
        ...
        (this.isMultiLine = a
          ? !0
          : o ? !1 : this.element.prop('isContentEditable')),
    ...
    _determineButtonType: function() {
      ...
      (this.type = this.element.is('[type=checkbox]')
        ...
        : this.element.is('[type=radio]')
          ? 'radio'
          : this.element.is('input') ? 'input' : 'button'),
