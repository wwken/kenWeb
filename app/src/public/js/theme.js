      ...
      var parallaxEffectOnScrolResize = function() {
        $window.on('scroll resize', function() {
          ...
          yPos =
            ...
            (self.options.speed + 2 + self.options.offset);
    ...
    Nav: {
      ...
      events: function() {
        ...
        if (isIE9 && isHeaderFlex && $window.width() > 991) {
          headerNavHeight = $header.find('.header-nav').css({
            height: $header.find('.header-top').get(0)
              ? $header.find('.header-body').height() -
                $header.find('.header-top').outerHeight() +
                4
              : $header.find('.header-body').height(),
          });
          ...
          $header.find('.header-nav-main nav > ul > li > a').css({
            'line-height':
              $('.header-nav-main nav > ul > li > a').height() + 'px',
          });
        ...
        if (isEdge) {
          $(
            '#header.header-flex .header-nav-main nav > ul > li.dropdown .dropdown-menu'
          ).css({
            'margin-top': '-1px',
          });
        }
  ...
  $document.ready(function() {
        ...
        chart.appear(function() {
          if (!jQuery(this).hasClass('animated')) {
            ...
            var animatePercentage = parseInt(
              jQuery(this).attr('data-animatepercent'),
              10
            );
            jQuery(this)
              .data('easyPieChart')
              .update(animatePercentage);
          }
        });
      });
    }
    ...
    function initSticky() {
      var $navbarSticky,
        ...
        $brandLogo,
        $brandLogoImg,
        centerLogoNormalHeight,
        centerLogoStickyHeight;
    ...
    $(
      '.popup-youtube, .popup-vimeo, .popup-gmaps, .magnific-iframe'
    ).magnificPopup({
      disableOn: 700,
      type: 'iframe',
      mainClass: 'mfp-fade',
    ...
    function ___Parallax() {
      var isMobileAlt = navigator.userAgent
        .toLowerCase()
    ...
    $('div.carousel-wrap').each(function() {
      ...
      slider.find('.customNavigation .next').click(function() {
        slider
          .find('div.owl-carousel:not(.manual)')
    ...
    /*==============================================
       ...
       ===============================================*/
    $body.append(
      "<a data-scroll class='lift-off js-lift-off lift-off_hide' href='#'><i class='fa fa-angle-up'></i></a>"
    );
        ...
        $(parentid)
          ...
          .on('click', function(ev) {
            ...
            if (childsub && opt.multipletab == false) {
              childsub
                .siblings(vars.listsub)
                .removeClass(vars.showclass)
                .slideUp(500);
              if (childsub.hasClass(vars.showclass)) {
                childsub.removeClass(vars.showclass).slideUp(500);
              } else {
