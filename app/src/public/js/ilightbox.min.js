!(function($, window, undefined) {
  ...
  function doAjax(e, t) {
    var e =
      'http://ilightbox.net/getSource/jsonp.php?url=' +
  ...
  function getTypeByExtension(e) {
    var t,
      o = getExtension(e);
    return (t =
      -1 !== extensions.image.indexOf(o)
        ? 'image'
        : -1 !== extensions.video.indexOf(o) ? 'video' : 'iframe');
  }
            ...
            t.protocol || t.authority || '/' === t.pathname.charAt(0)
              ...
              : t.pathname
                ? (e.authority && !e.pathname ? '/' : '') +
                  e.pathname.slice(
                    0,
                    e.pathname.lastIndexOf('../index.html') + 1
                  ) +
                  t.pathname
                : e.pathname
          ) +
  ...
  function _QTAddAttribute(e, t, o) {
    ...
    return (
      ...
      null != i
        ? (0 == t.indexOf(e) && null == o && (o = t.substring(e.length)),
          null == o && (o = t),
          o + '="' + i + '" ')
        : ''
    );
  ...
  function _QTAddObjectParam(e, t) {
    ...
    return (
      -1 == e.indexOf('emb#') &&
        ((o = gTagAttrs['obj#' + e]),
        null == o && (o = gTagAttrs[e]),
        0 == e.indexOf('obj#') && (e = e.substring(4)),
        null != o &&
          (i = '  <param name="' + e + '" value="' + o + '"' + n + '\n')),
      i
    );
  }
  ...
  function _QTGenerate(e, t, o) {
    ...
    (gTagAttrs = []),
      ...
      (null == e || '' == e) && (e = '6,0,2,0'),
      (gTagAttrs.codebase =
        'http://www.apple.com/qtactivex/qtplugin.cab#version=' + e);
    ...
    for (i in gTagAttrs)
      (e = gTagAttrs[i]),
        null != e &&
          ((n += _QTAddEmbedAttr(i)), (o += _QTAddObjectParam(i, t)));
    return o + n + '> </embed>\n</object>';
  }
  ...
  var extensions = {
    ...
    touchStartEvent = supportTouch
      ? 'touchstart.iLightBox'
      : 'mousedown.iLightBox',
    touchStopEvent = supportTouch ? 'touchend.iLightBox' : 'mouseup.iLightBox',
    touchMoveEvent = supportTouch
      ? 'touchmove.iLightBox'
      : 'mousemove.iLightBox',
    abs = Math.abs,
    sqrt = Math.sqrt,
    ...
    iLightBox = function(e, t, o, i) {
      ...
      if (
        ...
        (n.vars = {
          ...
          closeButton: $(
            '<a class="ilightbox-close" title="' +
              n.options.text.close +
              '"></a>'
          ),
          fullScreenButton: $(
            '<a class="ilightbox-fullscreen" title="' +
              n.options.text.enterFullscreen +
              '"></a>'
          ),
          innerPlayButton: $(
            '<a class="ilightbox-play" title="' +
              n.options.text.slideShow +
              '"></a>'
          ),
          innerNextButton: $(
        ...
        n.availPlugins(),
        (n.options.startFrom =
          n.options.startFrom > 0 && n.options.startFrom >= n.vars.total
            ? n.vars.total - 1
            : n.options.startFrom),
        (n.options.startFrom = n.options.randomStart
          ? floor(random() * n.vars.total)
          : n.options.startFrom),
        ...
        var r = /(click|mouseenter|mouseleave|mouseover|mouseout)/gi,
          a = 'itap';
        (n.options.caption.show = n.options.caption.show.replace(r, a)),
          (n.options.caption.hide = n.options.caption.hide.replace(r, a)),
          (n.options.social.show = n.options.social.show.replace(r, a)),
          (n.options.social.hide = n.options.social.hide.replace(r, a));
      }
      n.options.controls.arrows &&
        $.extend(n.options.styles, {
          nextOffsetX: 0,
          prevOffsetX: 0,
          nextOpacity: 0,
          prevOpacity: 0,
  ...
  (iLightBox.prototype = {
    showLoader: function() {
      ...
      (e.vars.loadRequests += 1),
        'horizontal' == e.options.path.toLowerCase()
          ? e.vars.loader
              .stop()
              .animate({ top: '-30px' }, e.options.show.speed, 'easeOutCirc')
          : e.vars.loader
              .stop()
              .animate({ left: '-30px' }, e.options.show.speed, 'easeOutCirc');
    },
    hideLoader: function() {
      var e = this;
      (e.vars.loadRequests -= 1),
        (e.vars.loadRequests =
          e.vars.loadRequests < 0 ? 0 : e.vars.loadRequests),
        'horizontal' == e.options.path.toLowerCase()
          ? e.vars.loadRequests <= 0 &&
            e.vars.loader
              .stop()
              .animate({ top: '-192px' }, e.options.show.speed, 'easeInCirc')
          : e.vars.loadRequests <= 0 &&
            e.vars.loader
              .stop()
              .animate({ left: '-192px' }, e.options.show.speed, 'easeInCirc');
    },
    createUI: function() {
      var e = this;
      e.ui = {
    ...
    attachItems: function() {
      ...
      $(iL.selector, iL.context).each(function() {
        var t = $(this),
          ...
          options =
            (t.data('options') && eval('({' + t.data('options') + '})')) || {},
    ...
    normalizeItems: function() {
      ...
      $.each(e.items, function(o, i) {
        ...
        (r.thumbnail = r.thumbnail || ('image' == l ? n : null)),
          (r.videoType = r.videoType || null),
          (r.skin = r.skin || e.options.skin),
          (r.width = r.width || null),
          (r.height = r.height || null),
          (r.mousewheel =
            'undefined' != typeof r.mousewheel ? r.mousewheel : !0),
          (r.swipe = 'undefined' != typeof r.swipe ? r.swipe : !0),
          (r.social =
            'undefined' != typeof r.social
              ? r.social
              : e.options.social.buttons &&
                $.extend({}, {}, e.options.social.buttons)),
          'video' == l &&
            ((r.html5video =
              'undefined' != typeof r.html5video ? r.html5video : {}),
            (r.html5video.webm =
              r.html5video.webm || r.html5video.WEBM || null),
            (r.html5video.controls =
              'undefined' != typeof r.html5video.controls
                ? r.html5video.controls
                : 'controls'),
            (r.html5video.preload = r.html5video.preload || 'metadata'),
            (r.html5video.autoplay =
              'undefined' != typeof r.html5video.autoplay
                ? r.html5video.autoplay
                : !1)),
          (r.width && r.height) ||
            ('video' == l
              ? ((r.width = 1280), (r.height = 720))
              : 'iframe' == l && ((r.width = '100%'), (r.height = '90%'))),
          delete i.url,
          (i.index = o),
          (i.URL = n),
          (i.caption = a),
    ...
    addContents: function() {
      var e = this,
        ...
        r =
          ...
          e.items.filter(function(e) {
            return (
              -1 === ['image', 'video'].indexOf(e.type) &&
              'undefined' == typeof e.recognized &&
              (o.smartRecognition || e.options.smartRecognition)
            );
          }),
        a = r.length > 0;
      o.mobileOptimizer &&
        !o.innerToolbar &&
        (t.isMobile = i.width <= t.mobileMaxWidth),
        t.overlay
          .addClass(o.skin)
          .hide()
          .css('opacity', o.overlay.opacity),
        o.linkId && t.overlay[0].setAttribute('linkid', o.linkId),
        o.controls.toolbar &&
          (t.toolbar.addClass(o.skin).append(t.closeButton),
          o.controls.fullscreen && t.toolbar.append(t.fullScreenButton),
          o.controls.slideshow && t.toolbar.append(t.innerPlayButton),
          t.total > 1 &&
            t.toolbar.append(t.innerPrevButton).append(t.innerNextButton)),
        t.BODY
          .addClass('ilightbox-noscroll')
          .append(t.overlay)
          .append(t.loader)
          .append(t.holder)
          .append(t.nextPhoto)
      ...
      t.loader.addClass(o.skin).css(s),
        ...
        o.infinite ||
          (t.prevButton
            .add(t.prevButton)
            .add(t.innerPrevButton)
            .add(t.innerNextButton)
            .removeClass('disabled'),
          0 == t.current &&
            t.prevButton.add(t.innerPrevButton).addClass('disabled'),
          t.current >= t.total - 1 &&
            t.nextButton.add(t.innerNextButton).addClass('disabled')),
        o.show.effect
          ? (t.overlay.stop().fadeIn(o.show.speed),
            t.toolbar.stop().fadeIn(o.show.speed))
          : (t.overlay.show(), t.toolbar.show());
      var l = r.length;
      a
        ? (e.showLoader(),
          $.each(r, function() {
        ...
        o.slideshow.startPaused ||
          (e.resume(),
          t.innerPlayButton
            .removeClass('ilightbox-play')
            .addClass('ilightbox-pause')),
        'function' == typeof e.options.callback.onOpen &&
          e.options.callback.onOpen.call(e);
    },
    loadContent: function(e, t, o) {
      var i,
        ...
        r = this;
      switch ((r.createUI(),
      (e.speed = o || r.options.effects.loadedFadeSpeed),
      'current' == t &&
        ((r.vars.lockWheel = e.options.mousewheel ? !1 : !0),
        (r.vars.lockSwipe = e.options.swipe ? !1 : !0)),
      t)) {
        case 'current':
      ...
      if (
        ...
        e.title || r.options.innerToolbar)
      ) {
        ...
        r.options.innerToolbar &&
          a.append(r.vars.total > 1 ? r.vars.toolbar.clone() : r.vars.toolbar),
          i.prepend(a);
      }
    ...
    loadSwitcher: function(e, t, o, i) {
      var n = this,
        r = n.options,
        a = { element: t, position: o };
      switch (e.type) {
        case 'image':
          'function' == typeof r.callback.onBeforeLoad &&
            r.callback.onBeforeLoad.call(n, n.ui, o),
            'function' == typeof e.options.onBeforeLoad &&
              e.options.onBeforeLoad.call(n, a),
            n.loadImage(e.URL, function(s) {
              'function' == typeof r.callback.onAfterLoad &&
                r.callback.onAfterLoad.call(n, n.ui, o),
                'function' == typeof e.options.onAfterLoad &&
                  e.options.onAfterLoad.call(n, a);
              var l = s ? s.width : 400,
                c = s ? s.height : 200;
              t.data({ naturalWidth: l, naturalHeight: c }),
                $('div.ilightbox-container', t)
                  ...
                  .append(
                    s
                      ? '<img src="' + e.URL + '" class="ilightbox-image" />'
                      : '<span class="ilightbox-alert">' +
                        r.errors.loadImage +
                        '</span>'
                  ),
                'function' == typeof r.callback.onRender &&
                  r.callback.onRender.call(n, n.ui, o),
                'function' == typeof e.options.onRender &&
                  e.options.onRender.call(n, a),
            ...
            $.ajax({
              ...
              success: function(s, l, c) {
                ...
                var d = $(s),
                  ...
                  p =
                    n.items[o].options.width ||
                    parseInt(d[0].getAttribute('width')),
                  f =
                    n.items[o].options.height ||
                    parseInt(d[0].getAttribute('height')),
                  g =
                    d[0].getAttribute('width') && d[0].getAttribute('height')
                      ? { overflow: 'hidden' }
                      : {};
                h.empty().append(
                  $('<div class="ilightbox-wrapper"></div>')
                    .css(g)
                    .html(d)
                ),
                  t
                ...
                n.loadImage(m, function() {
                  ...
                  r.ajaxSetup.success(s, l, c),
                  'function' == typeof u.success && u.success(s, l, c);
              },
              error: function(s, l, c) {
                'function' == typeof r.callback.onAfterLoad &&
                  ...
                  $('div.ilightbox-container', t)
                    ...
                    .append(
                      '<span class="ilightbox-alert">' +
                        r.errors.loadContents +
                        '</span>'
                    ),
                  n.configureHolder(e, i, t),
                  r.ajaxSetup.error(s, l, c),
                  'function' == typeof u.error && u.error(s, l, c);
              },
            });
          break;
        case 'html':
          ...
          n.addContent(t, e),
            s.appendTo(document.documentElement).hide(),
            'function' == typeof r.callback.onRender &&
              r.callback.onRender.call(n, n.ui, o),
            'function' == typeof e.options.onRender &&
              e.options.onRender.call(n, a);
    ...
    configureHolder: function(e, t, o) {
      ...
      if (
        ('current' != t &&
          o.addClass('next' == t ? 'ilightbox-next' : 'ilightbox-prev'),
        'current' == t)
      )
        var a = n.current;
      else if ('next' == t)
        ...
        var s = r.styles.prevOpacity,
          a = n.prev;
      var l = { element: o, position: a };
      (i.items[a].options.width = i.items[a].options.width || 0),
        (i.items[a].options.height = i.items[a].options.height || 0),
        'current' == t
          ? r.show.effect
            ? o.css(transform, gpuAcceleration).fadeIn(e.speed, function() {
                ...
                s &&
                  (i.setSocial(s, e.URL, o),
                  r.social.start &&
                    $('div.ilightbox-social', o).fadeIn(r.effects.fadeSpeed)),
                  i.generateThumbnails(),
                  'function' == typeof r.callback.onShow &&
                    r.callback.onShow.call(i, i.ui, a),
                  'function' == typeof e.options.onShow &&
                    e.options.onShow.call(i, l);
              })
            : (o.show(),
              i.generateThumbnails(),
              'function' == typeof r.callback.onShow &&
    ...
    generateBoxes: function() {
      var e = this,
        t = e.vars,
        o = e.options;
      o.infinite && t.total >= 3
        ? (t.current == t.total - 1 && (t.next = 0),
          0 == t.current && (t.prev = t.total - 1))
        : (o.infinite = !1),
        ...
        a.removeAttr('style').empty(),
          $.each(e.items, function(l, c) {
            var u = t.current == l ? 'ilightbox-active' : '',
              d =
                t.current == l
                  ? o.thumbnails.activeOpacity
                  : o.thumbnails.normalOpacity,
              h = c.options.thumbnail,
              p = $('<div class="ilightbox-thumbnail"></div>'),
              f = $('<div class="ilightbox-thumbnail-icon"></div>');
            p.css({ opacity: 0 }).addClass(u),
              'video' == c.type && 'undefined' == typeof c.options.icon
                ? (f.addClass('ilightbox-thumbnail-video'), p.append(f))
                : c.options.icon &&
                  (f.addClass('ilightbox-thumbnail-' + c.options.icon),
                  p.append(f)),
              h &&
                e.loadImage(h, function(t) {
                  s++,
                    t
                      ? p
                          .data({
    ...
    positionThumbnails: function(e, t, o) {
      ...
      var l = $('.ilightbox-thumbnail', o),
        c =
          'horizontal' == s
            ? a.width - r.styles.pageOffsetX
            : l.eq(0).outerWidth() - r.styles.pageOffsetX,
        u =
          'horizontal' == s
            ? l.eq(0).outerHeight() - r.styles.pageOffsetY
            : a.height - r.styles.pageOffsetY,
        d = 'horizontal' == s ? 0 : c,
        h = 'horizontal' == s ? u : 0,
        p = $('.ilightbox-active', o),
        f = {};
      arguments.length < 3 &&
        (l.css({ opacity: r.thumbnails.normalOpacity }),
        p.css({ opacity: r.thumbnails.activeOpacity })),
        l.each(function() {
          var e = $(this),
            t = e.data(),
            o = 'horizontal' == s ? 0 : r.thumbnails.maxWidth;
          (height = 'horizontal' == s ? r.thumbnails.maxHeight : 0),
            (dims = i.getNewDimenstions(
              o,
              height,
              t.naturalWidth,
              t.naturalHeight,
            ...
            e.css({ width: dims.width, height: dims.height }),
            'horizontal' == s && e.css({ float: 'left' }),
      ...
      var g = o.offset(),
        m = p.length
          ? p.offset()
          : { top: parseInt(u / 2), left: parseInt(c / 2) };
      (g.top = g.top - $doc.scrollTop()),
        ...
        'horizontal' == s
          ? ((f.top = 0),
            (f.left = parseInt(c / 2 - m.left - p.outerWidth() / 2)))
          : ((f.top = parseInt(u / 2 - m.top - p.outerHeight() / 2)),
            (f.left = 0)),
        arguments.length < 3
          ? o.stop().animate(f, r.effects.repositionSpeed, 'easeOutCirc')
          : o.css(f);
    },
    ...
    patchEvents: function() {
      function e(e) {
        o.isMobile ||
          (o.mouseID || o.hideableElements.show(),
          (o.mouseID = clearTimeout(o.mouseID)),
          -1 === c.indexOf(e.target) &&
            (o.mouseID = setTimeout(function() {
      ...
      var t = this,
        ...
        c = [
          o.nextButton[0],
          o.prevButton[0],
          o.nextButton[0].firstChild,
          o.prevButton[0].firstChild,
        ];
      $win
        .bind('resize.iLightBox', function() {
          ...
          i.mobileOptimizer &&
            !i.innerToolbar &&
            (o.isMobile = e.width <= o.mobileMaxWidth),
            o.BODY[o.isMobile ? 'addClass' : 'removeClass']('isMobile'),
            t.repositionPhoto(null),
            supportTouch &&
              (clearTimeout(o.setTime),
      ...
      var u = [
          i.caption.show + '.iLightBox',
          i.caption.hide + '.iLightBox',
          i.social.show + '.iLightBox',
          i.social.hide + '.iLightBox',
      ...
      $.each(u, function(e, t) {
        ...
        $doc
          ...
          .on(
            clickEvent,
            '.ilightbox-next, .ilightbox-next-button',
            function() {
              t.moveTo('next');
            }
          )
          .on(
            clickEvent,
            '.ilightbox-prev, .ilightbox-prev-button',
            function() {
              t.moveTo('prev');
            }
          )
          ...
          .on(
            ...
            function(e) {
              ...
              o.nextLock || o.prevLock
                ? (e.type != i.caption.show || t.is(':visible')
                    ? e.type == i.caption.hide &&
                      t.is(':visible') &&
                      t.fadeOut(r)
                    : t.fadeIn(r),
                  e.type != i.social.show || n.is(':visible')
                    ? e.type == i.social.hide &&
                      n.is(':visible') &&
                      n.fadeOut(r)
                    : n.fadeIn(r))
                : (e.type != i.caption.show || t.is(':visible')
          ...
          .on(
            ...
            function() {
              var e = $(this);
              e.hasClass('ilightbox-fullscreen')
                ? t.fullScreenAction()
                : e.hasClass('ilightbox-play')
                  ? (t.resume(),
                    e.addClass('ilightbox-pause').removeClass('ilightbox-play'))
                  : e.hasClass('ilightbox-pause')
                    ? (t.pause(),
                      e
                        .addClass('ilightbox-play')
                        .removeClass('ilightbox-pause'))
                    : t.closeAction();
            }
          )
          .on(
        ...
        i.controls.arrows && !supportTouch && $doc.on('mousemove.iLightBox', e),
        i.controls.slideshow &&
          ...
          $doc.on(
            ...
            '.ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)',
            function(e) {
              'mouseenter' == e.type && o.cycleID
                ? t.pause()
                : 'mouseleave' == e.type && o.isPaused && t.resume();
            }
          );
      var h = $('.ilightbox-overlay, .ilightbox-holder, .ilightbox-thumbnails');
      i.controls.mousewheel &&
        h.on('mousewheel.iLightBox', function(e, i) {
          o.lockWheel ||
            (e.preventDefault(),
            0 > i ? t.moveTo('next') : i > 0 && t.moveTo('prev'));
        }),
        i.controls.swipe &&
          r.on(touchStartEvent, function(e) {
            function a(e) {
              var t = $(this),
                o = m[e],
                i = [v.coords[0] - d.coords[0], v.coords[1] - d.coords[1]];
              t[0].style['horizontal' == n ? 'left' : 'top'] =
                ('horizontal' == n ? o.left - i[0] : o.top - i[1]) + 'px';
            }
            function c(e) {
              if (v) {
            ...
            function u() {
              r.each(function() {
                ...
                e
                  ...
                  .stop()
                  .animate({ top: o, left: i }, 500, 'easeOutCirc', function() {
                    e.css(transform, '');
                  });
              });
            }
            if (!(o.nextLock || o.prevLock || 1 == o.total || o.lockSwipe)) {
              ...
              var d,
                h = e.originalEvent.touches ? e.originalEvent.touches[0] : e,
                p = $doc.scrollTop(),
                f = $doc.scrollLeft(),
                g = [r.eq(0).offset(), r.eq(1).offset(), r.eq(2).offset()],
                m = [
                  { top: g[0].top - p, left: g[0].left - f },
                  { top: g[1].top - p, left: g[1].left - f },
                  { top: g[2].top - p, left: g[2].left - f },
                ],
                v = {
                  time: new Date().getTime(),
                  coords: [h.pageX - f, h.pageY - p],
                };
              r.bind(touchMoveEvent, c),
                $doc.one(touchStopEvent, function() {
                  r.unbind(touchMoveEvent, c),
                    o.BODY.removeClass('ilightbox-closedhand'),
                    v &&
                      d &&
                      ('horizontal' == n &&
                      d.time - v.time < s &&
                      abs(v.coords[0] - d.coords[0]) > l &&
                      abs(v.coords[1] - d.coords[1]) < verticalDistanceThreshold
                        ? v.coords[0] > d.coords[0]
                          ? o.current != o.total - 1 || i.infinite
                            ? ((o.isSwipe = !0), t.moveTo('next'))
                            : u()
                          : 0 != o.current || i.infinite
                            ? ((o.isSwipe = !0), t.moveTo('prev'))
                            : u()
                        : 'vertical' == n &&
                          d.time - v.time < s &&
                          abs(v.coords[1] - d.coords[1]) > l &&
                          abs(v.coords[0] - d.coords[0]) <
                            verticalDistanceThreshold
                          ? v.coords[1] > d.coords[1]
                            ? o.current != o.total - 1 || i.infinite
                              ? ((o.isSwipe = !0), t.moveTo('next'))
                              : u()
                            : 0 != o.current || i.infinite
    ...
    goTo: function(e) {
      ...
      if (
        ...
        'function' == typeof i.callback.onBeforeChange &&
          i.callback.onBeforeChange.call(t, t.ui),
          i.linkId &&
            ((o.hashLock = !0), (window.location.hash = i.linkId + '/' + e)),
          t.items[e] &&
            (t.items[e].options.mousewheel
              ? (t.vars.lockWheel = !1)
              : (o.lockWheel = !0),
            (o.lockSwipe = t.items[e].options.swipe ? !1 : !0)),
          $.each([o.holder, o.nextPhoto, o.prevPhoto], function(e, t) {
            t
              .css(transform, gpuAcceleration)
              .fadeOut(i.effects.loadedFadeSpeed);
          }),
          (o.current = e),
          (o.next = e + 1),
          (o.prev = e - 1),
          ...
          $('.ilightbox-thumbnail', o.thumbnails)
          ...
          i.infinite ||
            (o.nextButton
              .add(o.prevButton)
              .add(o.innerPrevButton)
              .add(o.innerNextButton)
              .removeClass('disabled'),
            0 == o.current &&
              o.prevButton.add(o.innerPrevButton).addClass('disabled'),
            o.current >= o.total - 1 &&
              o.nextButton.add(o.innerNextButton).addClass('disabled')),
          t.resetCycle(),
          'function' == typeof i.callback.onAfterChange &&
            i.callback.onAfterChange.call(t, t.ui);
      }
    },
    moveTo: function(e) {
      var t = this,
      ...
      if (
        (i.linkId &&
          ((o.hashLock = !0), (window.location.hash = i.linkId + '/' + s)),
        'next' == e)
      ) {
      ...
      if (
        (p.length &&
          p.stop().fadeOut(a, function() {
            $(this).remove();
          }),
        f.length &&
          f.stop().fadeOut(a, function() {
            $(this).remove();
          }),
        t.items[s].caption)
      ) {
      ...
      v &&
        (t.setSocial(v, t.items[s].URL, l),
        i.social.start &&
          $('div.ilightbox-social', l).fadeIn(i.effects.fadeSpeed)),
        $.each([l, c, u], function(e, t) {
      ...
      l
        .css(transform, gpuAcceleration)
        .animate(
          { top: k, left: A, opacity: 1 },
          a,
          o.isSwipe ? 'easeOutCirc' : 'easeInOutCirc',
          function() {
            l.css(transform, '');
          }
        ),
      ...
      (L = I.diff),
        (y = I.newDims.width),
        (S = I.newDims.height),
        (y = parseInt(y * i.styles['next' == e ? 'prevScale' : 'nextScale'])),
        (S = parseInt(S * i.styles['next' == e ? 'prevScale' : 'nextScale'])),
        (k = parseInt(
          'horizontal' == n
            ? w / 2 - C.offsetY - S / 2 - L.H - T.H / 2
            : w - C.offsetX - L.H - T.H / 2
        )),
        'prev' == e
          ? (A = parseInt(
              'horizontal' == n
                ? x - C.offsetX - L.W - T.W / 2
                : x / 2 - y / 2 - L.W - C.offsetY - T.W / 2
            ))
          : ((k =
              'horizontal' == n ? k : parseInt(C.offsetX - L.H - S - T.H / 2)),
            (A = parseInt(
              'horizontal' == n
                ? C.offsetX - L.W - y - T.W / 2
                : x / 2 - C.offsetY - y / 2 - L.W - T.W / 2
            ))),
        $('div.ilightbox-container', c).animate(
          { width: y, height: S },
          a,
          o.isSwipe ? 'easeOutCirc' : 'easeInOutCirc'
        ),
        c
          ...
          .css(transform, gpuAcceleration)
          .animate(
            { top: k, left: A, opacity: i.styles.prevOpacity },
            a,
            o.isSwipe ? 'easeOutCirc' : 'easeInOutCirc',
            function() {
              c.css(transform, ''),
                ...
                t.positionThumbnails(),
                t.items[s] &&
                  ((o.lockWheel = t.items[s].options.mousewheel ? !1 : !0),
                  (o.lockSwipe = t.items[s].options.swipe ? !1 : !0)),
                (o.isSwipe = !1),
                'next' == e
                  ? ((o.nextPhoto = u),
                    (o.prevPhoto = c),
                    ...
                    i.infinite &&
                      (o.current > o.total - 1 && (o.current = 0),
                      o.current == o.total - 1 && (o.next = 0),
                      0 == o.current && (o.prev = o.total - 1)),
                    t.createUI(),
                    t.items[o.next]
                      ? t.loadContent(t.items[o.next], 'next')
                      : (o.nextLock = !1))
                  : ((o.prevPhoto = u),
                    (o.nextPhoto = c),
                    (o.holder = l),
                    ...
                    t.createUI(),
                    t.items[o.prev]
                      ? t.loadContent(t.items[o.prev], 'prev')
                      : (o.prevLock = !1)),
                i.linkId &&
                  setTimeout(function() {
                    o.hashLock = !1;
        ...
        (k =
          'horizontal' == n
            ? getPixel(u, 'top')
            : parseInt('next' == e ? -(w / 2) - u.outerHeight() : 2 * k)),
        (A =
          'horizontal' == n
            ? parseInt('next' == e ? -(x / 2) - u.outerWidth() : 2 * A)
            : getPixel(u, 'left')),
        u
          .css(transform, gpuAcceleration)
          .animate(
            { top: k, left: A, opacity: i.styles.nextOpacity },
            a,
            o.isSwipe ? 'easeOutCirc' : 'easeInOutCirc',
            function() {
              u.css(transform, '');
    ...
    setCaption: function(e, t) {
      ...
      e.caption &&
        (o.html(e.caption), $('div.ilightbox-container', t).append(o));
    },
      ...
      return (
        $.each(e, function(o, r) {
          ...
          switch (l) {
            case 'facebook':
              (a =
                'http://www.facebook.com/share.php?v=4&amp;src=bm&amp;u={URL}'),
                (s = 'Share on Facebook');
              break;
            case 'twitter':
          ...
          e[o] = {
            URL:
              (r.URL && absolutizeURI(n, r.URL)) ||
              (i.linkId && window.location.href) ||
              ('string' != typeof t && n) ||
              (t && absolutizeURI(n, t)) ||
              n,
            source:
            ...
            width:
              'undefined' == typeof r.width || isNaN(r.width)
                ? 640
                : parseInt(r.width),
            height: r.height || 360,
          };
    ...
    setSocial: function(e, t, o) {
      ...
      (e = i.normalizeSocial(e, t)),
        ...
        (r += '</ul>'),
        n.html(r),
        $('div.ilightbox-container', o).append(n);
    },
      ...
      if (i.fullAlone) {
        ...
        if (t.isInFullScreen)
          (t.isInFullScreen = t.lockKey = t.lockWheel = t.lockSwipe = !1),
            ...
            'function' == typeof i.callback.onExitFullScreen &&
              i.callback.onExitFullScreen.call(e, e.ui);
        else {
          if (
            ...
            -1 != i.fullStretchTypes.indexOf(r.type))
          )
            n.data({
          ...
          $.each(l, function(e, t) {
            ...
            'function' == typeof i.callback.onEnterFullScreen &&
              i.callback.onEnterFullScreen.call(e, e.ui);
        }
    ...
    closeAction: function() {
      ...
      $win.unbind('.iLightBox'),
        ...
        t.isInFullScreen &&
          fullScreenApi.cancelFullScreen(document.documentElement),
        $('.ilightbox-overlay, .ilightbox-holder, .ilightbox-thumbnails').off(
          '.iLightBox'
        ),
        o.hide.effect
          ? t.overlay.stop().fadeOut(o.hide.speed, function() {
              t.overlay.remove(),
      ...
      $.each(i, function(e, t) {
        ...
        'function' == typeof o.callback.onHide &&
          o.callback.onHide.call(e, e.ui);
    },
    repositionPhoto: function() {
      var e = this,
        ...
        a = n.height,
        s =
          (t.isInFullScreen && o.fullAlone) || t.isMobile
            ? 0
            : 'horizontal' == i ? 0 : t.thumbnails.outerWidth(),
        l = t.isMobile
          ? t.toolbar.outerHeight()
          : t.isInFullScreen && o.fullAlone
            ? 0
            : 'horizontal' == i ? t.thumbnails.outerHeight() : 0,
        c = t.isInFullScreen && o.fullAlone ? r : r - o.styles.pageOffsetX,
        u = t.isInFullScreen && o.fullAlone ? a : a - o.styles.pageOffsetY,
        d =
          'horizontal' == i
            ? parseInt(
                e.items[t.next] || e.items[t.prev]
                  ? 2 * (o.styles.nextOffsetX + o.styles.prevOffsetX)
                  : 30 >= c / 10 ? 30 : c / 10
              )
            : parseInt(30 >= c / 10 ? 30 : c / 10) + s,
        h =
          'horizontal' == i
            ? parseInt(30 >= u / 10 ? 30 : u / 10) + l
            : parseInt(
                e.items[t.next] || e.items[t.prev]
                  ? 2 * (o.styles.nextOffsetX + o.styles.prevOffsetX)
                  : 30 >= u / 10 ? 30 : u / 10
    ...
    repositionEl: function(e) {
      var t = this,
        ...
        n = i.path.toLowerCase(),
        r =
          'current' == e.type && o.isInFullScreen && i.fullAlone
            ? e.width
            : e.width - e.offsetW,
        a =
          'current' == e.type && o.isInFullScreen && i.fullAlone
      ...
      'current' == e.type
        ? ('number' == typeof l.width &&
            ...
            (r =
              o.isInFullScreen &&
              i.fullAlone &&
              (-1 != i.fullStretchTypes.indexOf(s.type) ||
                l.fullViewPort ||
                i.fullViewPort)
                ? r
                : l.width > r ? r : l.width),
          'number' == typeof l.height &&
            ...
            (a =
              ...
              (-1 != i.fullStretchTypes.indexOf(s.type) ||
                ...
                i.fullViewPort)
                ? a
                : l.height > a ? a : l.height))
        : ('number' == typeof l.width &&
            l.width &&
            (r = l.width > r ? r : l.width),
          'number' == typeof l.height &&
            l.height &&
            (a = l.height > a ? a : l.height)),
        (a = parseInt(a - $('.ilightbox-inner-toolbar', c).outerHeight()));
      var f =
          'string' == typeof l.width && -1 != l.width.indexOf('%')
            ? percentToValue(parseInt(l.width.replace('%', '')), e.width)
            : c.data('naturalWidth'),
        g =
          'string' == typeof l.height && -1 != l.height.indexOf('%')
            ? percentToValue(parseInt(l.height.replace('%', '')), e.height)
            : c.data('naturalHeight'),
        m =
          ('string' == typeof l.width && -1 != l.width.indexOf('%')) ||
          ('string' == typeof l.height && -1 != l.height.indexOf('%'))
            ? { width: f, height: g }
      ...
      'prev' == e.type || 'next' == e.type
        ? ((f = parseInt(
            m.width *
              ('next' == e.type ? i.styles.nextScale : i.styles.prevScale)
          )),
          (g = parseInt(
            m.height *
              ('next' == e.type ? i.styles.nextScale : i.styles.prevScale)
          )))
        : ((f = m.width), (g = m.height));
      var b = parseInt(
          (getPixel(c, 'padding-left') +
            getPixel(c, 'padding-right') +
            getPixel(c, 'border-left-width') +
            getPixel(c, 'border-right-width')) /
            2
        ),
        x = parseInt(
          (getPixel(c, 'padding-top') +
            getPixel(c, 'padding-bottom') +
            getPixel(c, 'border-top-width') +
            getPixel(c, 'border-bottom-width') +
            $('.ilightbox-inner-toolbar', c).outerHeight()) /
            2
        );
      switch (e.type) {
        case 'current':
        ...
        case 'next':
          var w = parseInt(
              'horizontal' == n
                ? e.height / 2 - d - g / 2 - x - p / 2
                : e.height - u - x - p / 2
            ),
            y = parseInt(
              'horizontal' == n
                ? e.width - u - b - h / 2
                : e.width / 2 - f / 2 - b - d - h / 2
            );
          break;
        case 'prev':
          var w = parseInt(
      ...
      c.data('offset', {
        ...
        e.animate > 0 && i.effects.reposition
          ...
          : (c.css({ top: w, left: y }),
            $('div.ilightbox-container', c).css({ width: f, height: g }),
            $('div.ilightbox-inner-toolbar', c).css({ width: f }));
    },
    resume: function(e) {
      var t = this,
        o = t.vars,
      ...
      !i.slideshow.pauseTime ||
        (i.controls.slideshow && o.total <= 1) ||
        e < o.isPaused ||
        ((o.isPaused = 0),
    ...
    getNewDimenstions: function(e, t, o, i, n) {
      var r = this;
      (factor = e ? (t ? min(e / o, t / i) : e / o) : t / i),
        n ||
          (factor > r.options.maxScale
            ? (factor = r.options.maxScale)
            : factor < r.options.minScale && (factor = r.options.minScale));
      var a = r.options.keepAspectRatio ? round(o * factor) : e,
        s = r.options.keepAspectRatio ? round(i * factor) : t;
      return { width: a, height: s, ratio: factor };
    },
    ...
    availPlugins: function() {
      ...
      e.plugins = {
        quicktime:
          parseInt(PluginDetect.getVersion('QuickTime')) >= 0 ? !0 : !1,
        html5H264: !(
          !t.canPlayType || !t.canPlayType('video/mp4').replace(/no/, '')
        ),
        html5WebM: !(
          !t.canPlayType || !t.canPlayType('video/webm').replace(/no/, '')
        ),
        html5Vorbis: !(
          !t.canPlayType || !t.canPlayType('video/ogg').replace(/no/, '')
        ),
        html5QuickTime: !(
          !t.canPlayType || !t.canPlayType('video/quicktime').replace(/no/, '')
        ),
      };
    },
    addContent: function(e, t) {
      ...
      switch (t.type) {
        case 'video':
          ...
          ('video/mp4' == r || 'mp4' == t.ext || 'm4v' == t.ext || a.h264) &&
          i.plugins.html5H264
            ? ((t.ext = 'mp4'), (t.URL = a.h264 || t.URL))
            : a.webm && i.plugins.html5WebM
              ? ((t.ext = 'webm'), (t.URL = a.webm || t.URL))
              : a.ogg &&
                i.plugins.html5Vorbis &&
                ((t.ext = 'ogv'), (t.URL = a.ogg || t.URL)),
            !i.plugins.html5H264 ||
            ('video/mp4' != r && 'mp4' != t.ext && 'm4v' != t.ext)
              ? !i.plugins.html5WebM || ('video/webm' != r && 'webm' != t.ext)
                ? !i.plugins.html5Vorbis || ('video/ogg' != r && 'ogv' != t.ext)
                  ? !i.plugins.html5QuickTime ||
                    ('video/quicktime' != r &&
                      'mov' != t.ext &&
                      'qt' != t.ext) ||
                    ((n = !0), (r = 'video/quicktime'))
                  : ((n = !0), (r = 'video/ogg'))
                : ((n = !0), (r = 'video/webm'))
              : ((n = !0), (r = 'video/mp4')),
            n
              ? (o = $('<video />', {
                  ...
                  poster: a.poster,
                  controls: a.controls,
                }).append($('<source />', { src: t.URL, type: r })))
              : i.plugins.quicktime
                ? ((o = $('<object />', {
                ...
                : (o = $('<span />', {
                    ...
                    html: i.options.errors.missingPlugin
                      .replace('{pluginspage}', pluginspages.quicktime)
        ...
        case 'iframe':
          o = $('<iframe />').attr({
            width:
              ...
              t.options.width &&
              '1' == i.options.minScale &&
              '1' == i.options.maxScale
                ? t.options.width
                : '100%',
            height:
          ...
          break;
        case 'inline':
          o = $('<div class="ilightbox-wrapper"></div>').html(
            $(t.URL).clone(!0)
          );
          break;
        case 'html':
      ...
      return (
        $('div.ilightbox-container', e)
          .empty()
          .html(o),
        'video' === o[0].tagName.toLowerCase() &&
          browser.webkit &&
          setTimeout(function() {
          ...
          if ((o.hideLoader(), e)) {
            ...
            if (((i.length = !1), (i.url = e.url), 200 == e.status)) {
              var n = e.results,
                ...
                a = n.source;
              (i.source = a.src),
                (i.width = (a.width && parseInt(a.width)) || 0),
                (i.height = (a.height && parseInt(a.height)) || 0),
                (i.type = r),
                (i.thumbnail = a.thumbnail || n.images[0]),
                (i.html5video = n.html5video || {}),
                (i.length = !0),
                -1 != a.type.indexOf('video/index.html')
                  ? (i.type = 'video')
                  : -1 != a.type.indexOf('/html')
                    ? (i.type = 'iframe')
                    : -1 != a.type.indexOf('image/index.html') &&
                      (i.type = 'image');
      ...
      if (!(o.hashLock || ('#' + i.linkId != a[0] && r.length > 1)))
        if (s) {
          ...
          if (t.items[l]) {
            ...
            c.length && c.attr('linkid') == i.linkId
              ? t.goTo(l)
              : t.itemsObject[l].trigger(supportTouch ? 'itap' : 'click');
          } else {
            var c = $('.ilightbox-overlay');
    ...
    (function() {
      ...
      var e = { startEvent: 'touchstart.iTap', endEvent: 'touchend.iTap' };
      $.event.special.itap = {
        setup: function() {
          var t,
            o,
              ...
              n.one(e.endEvent, function(e) {
                ...
                (e = $.event.fix(n)),
                  ...
                  t &&
                    ...
                    t.x == o.x &&
                    t.y == o.y &&
                    ($.event.dispatch || $.event.handle).call(i, e),
                  (t = o = undefined);
              });
          });
        },
    ...
    (function() {
      ...
      (browser = {}),
        t.browser && ((browser[t.browser] = !0), (browser.version = t.version)),
        browser.chrome
          ? (browser.webkit = !0)
    ...
    (function() {
      ...
      (transform = e('transform') || ''),
        (gpuAcceleration = e('perspective') ? 'translateZ(0) ' : '');
    })();
  var PluginDetect = {
    version: '0.7.9',
    name: 'PluginDetect',
    ...
    getNum: function(e, t) {
      var o = this,
        i = o.isStrNum(e)
          ? (o.isDefined(t) ? new RegExp(t) : o.getNumRegx).exec(e)
          : null;
      return i ? i[0] : null;
    },
    compareNums: function(e, t, o) {
      ...
      if (a.isStrNum(e) && a.isStrNum(t)) {
        ...
        for (
          i = e.split(a.splitNumRegx), n = t.split(a.splitNumRegx), r = 0;
          r < min(i.length, n.length);
          r++
        ) {
      ...
      return function(t) {
        if (!e.isIE && t) {
          var o,
            i,
            n,
            r = e.isArray(t) ? t : e.isString(t) ? [t] : [];
          for (n = 0; n < r.length; n++)
            if (
              e.isString(r[n]) &&
              /[^\s]/.test(r[n]) &&
              ((o = navigator.mimeTypes[r[n]]),
              (i = o ? o.enabledPlugin : 0),
    ...
    findNavPlugin: function(e, t, o) {
      ...
      for (i = 0; i < u.length; i++)
        if (
          ...
          (n = u[i].name || d),
          ((s.test(r) &&
            (!l || l.test(RegExp.leftContext + RegExp.rightContext))) ||
            (s.test(n) &&
              (!l || l.test(RegExp.leftContext + RegExp.rightContext)))) &&
            (!c || (!c.test(r) && !c.test(n))))
        )
    ...
    getMimeEnabledPlugin: function(e, t, o) {
      ...
      for (a = 0; a < d.length; a++)
        if (
          ...
          ((r = i.description || c),
          (n = i.name || c),
          (l.test(r) || l.test(n)) && (!u || (!u.test(r) && !u.test(n))))
        )
          return i;
      return 0;
    },
    getPluginFileVersion: function(e, t) {
      ...
      for (
        o = a.formatNum(o),
          t = a.formatNum(t),
          i = t.split(a.splitNumRegx),
          n = o.split(a.splitNumRegx),
          r = 0;
        r < i.length;
        r++
      ) {
    ...
    convertFuncs: function(e) {
      ...
      for (t in e)
        if (i.test(t))
          try {
            (o = t.slice(2)),
              o.length > 0 && !e[o] && ((e[o] = e[t](e)), delete e[t]);
          } catch (n) {}
    },
    ...
    initScript: function() {
      ...
      for (e in t.Plugins)
        t.Plugins[e] &&
          t.initObj(t.Plugins[e], ['$', t, '$$', t.Plugins[e]], 1);
      ...
      if (
        ...
        (c = parseFloat(t.verIEfull || '0', 10)),
          (t.docModeIE =
            i.documentMode ||
            (/back/i.test(i.compatMode || '') ? 5 : c) ||
            t.verIE),
          (t.verIE = c || t.docModeIE);
      }
      ...
      (t.isGecko = /Gecko/i.test(s) && /Gecko\s*\/\s*\d/i.test(n)),
        (t.verGecko = t.isGecko
          ? t.formatNum(/rv\s*\:\s*([\.\,\d]+)/i.test(n) ? RegExp.$1 : '0.9')
          : null),
        (t.isChrome = /Chrome\s*\/\s*(\d[\d\.]*)/i.test(n)),
        (t.verChrome = t.isChrome ? t.formatNum(RegExp.$1) : null),
        (t.isSafari =
          (/Apple/i.test(r) || (!r && !t.isChrome)) &&
          /Safari\s*\/\s*(\d[\d\.]*)/i.test(n)),
        (t.verSafari =
          t.isSafari && /Version\s*\/\s*(\d[\d\.]*)/i.test(n)
            ? t.formatNum(RegExp.$1)
            : null),
        (t.isOpera = /Opera\s*[\/]?\s*(\d+\.?\d*)/i.test(n)),
        (t.verOpera = t.isOpera ? parseFloat(RegExp.$1, 10) : null),
    ...
    init: function(e) {
      ...
      return o.isString(e)
        ? 1 == e.length
          ? ((o.getVersionDelimiter = e), i)
          : ((e = e.toLowerCase().replace(/\s/g, '')),
            (t = o.Plugins[e]),
            t && t.getVersion
              ? ((i.plugin = t),
                o.isDefined(t.installed) ||
                  ((t.installed = null),
                  (t.version = null),
                  (t.version0 = null),
                  ...
                  (t.pluginName = e)),
                (o.garbage = !1),
                o.isIE && !o.ActiveXEnabled && 'java' !== e
                  ? ((i.status = -2), i)
                  : ((i.status = 1), i))
              : i)
        : i;
    ...
    fPush: function(e, t) {
      var o = this;
      o.isArray(t) &&
        (o.isFunc(e) || (o.isArray(e) && e.length > 0 && o.isFunc(e[0]))) &&
        t.push(e);
    },
    ...
    call: function(e) {
      ...
      o > 0 && t.isFunc(e[0])
        ? e[0](t, o > 1 ? e[1] : 0, o > 2 ? e[2] : 0, o > 3 ? e[3] : 0)
        : t.isFunc(e) && e(t);
    },
    getVersionDelimiter: ',',
    $$getVersion: function(e) {
      return function(t, o, i) {
        ...
        return a.status < 0
          ...
          : ((n = a.plugin),
            1 != n.getVersionDone &&
              (n.getVersion(null, o, i),
              null === n.getVersionDone && (n.getVersionDone = 1)),
            e.cleanup(),
            (r = n.version || n.version0),
            (r = r ? r.replace(e.splitNumRegx, e.getVersionDelimiter) : r));
      };
    },
    cleanup: function() {
      var e = this;
      e.garbage &&
        e.isDefined(window.CollectGarbage) &&
    ...
    codebaseSearch: function(e, t) {
      ...
      e.BIfuncs &&
        e.BIfuncs.length &&
        null !== e.BIfuncs[e.BIfuncs.length - 1] &&
        o.callArray(e.BIfuncs);
      var i,
        n = e.SEARCH;
      if (o.isStrNum(t))
        return n.match && n.min && o.compareNums(t, n.min) <= 0
          ? !0
          : n.match && n.max && o.compareNums(t, n.max) >= 0
            ? !1
            : ((i = o.isActiveXObject(e, t)),
              i && (!n.min || o.compareNums(t, n.min) > 0) && (n.min = t),
      ...
      i.isFunc(t) &&
        (n.addEventListener
          ...
          : n.attachEvent
            ...
            : ((o = n['on' + e]), (n['on' + e] = i.winHandler(t, o))));
    },
    ...
    emptyDiv: function() {
      ...
      if (
        (r.div || ((i = document.getElementById(r.divID)), i && (r.div = i)),
        r.div && r.div.parentNode)
      ) {
        try {
    ...
    onDoneEmptyDiv: function() {
      ...
      if (
        ...
        (!o.WLfuncs ||
          !o.WLfuncs.length ||
          null === o.WLfuncs[o.WLfuncs.length - 1])
      ) {
        for (e in o)
          if (((t = o[e]), t && t.funcs)) {
            if (3 == t.OTF) return;
      ...
      try {
        if (a == n.pluginSize && (!n.isIE || 4 == n.getDOMobj(e).readyState)) {
          ...
          if (
            e.winLoaded &&
            n.isNum(i) &&
            (n.isNum(e.count) || (e.count = i), i - e.count >= 10)
          )
            return 1;
        }
      } catch (d) {}
    ...
    insertDivInBody: function(e, t) {
      ...
      if (!a)
        try {
          r.write('<div id="' + i + '">.' + o.openTag + '/div>'),
            (n = r.getElementById(i));
        } catch (s) {}
      (a = r.getElementsByTagName('body')[0] || r.body),
        a && (a.insertBefore(e, a.firstChild), n && a.removeChild(n));
    },
    insertHTML: function(e, t, o, i) {
      ...
      if (
        (l.div ||
          ((a = s.getElementById(l.divID)),
          a
            ? (l.div = a)
            : ((l.div = s.createElement('div')), (l.div.id = l.divID)),
          l.setStyle(
            l.div,
            u.concat([
              'width',
        ...
        return { span: c, winLoaded: l.winLoaded, tagName: e, outerHTML: n };
      }
      return { span: null, winLoaded: l.winLoaded, tagName: '', outerHTML: n };
    },
    Plugins: {
      quicktime: {
        mimeType: [
        ...
        minIEver: 7,
        HTML:
          '<param name="src" value="" /><param name="controller" value="false" />',
        ...
        getVersion: function(e) {
          ...
          if (i.isIE) {
            if (
              (i.isStrNum(e) &&
                ((t = e.split(i.splitNumRegx)),
                t.length > 3 && parseInt(t[3], 10) > 0 && (t[3] = '9999'),
                (e = t.join(','))),
            ...
            (o.getVersionDone = 1),
              !n &&
                i.verIE >= o.minIEver &&
                (n = o.CDBASE2VER(i.codebaseSearch(o))),
              n ||
                ((r = i.getAXO(o.progID)),
                r &&
                  r.QuickTimeVersion &&
                  ((n = r.QuickTimeVersion.toString(16)),
                  (n =
            ...
            i.hasMimeType(o.mimeType) &&
              ((r =
                3 != i.OS ? i.findNavPlugin('QuickTime.*Plug-?in', 0) : null),
              r && r.name && (n = i.getNum(r.name)));
        ...
        CDBASE2VER: function(e) {
          ...
          if (e)
            for (e = i.formatNum(e), t = 0; t < n.length; t++)
              if (
                n[t] &&
                i.compareNums(e, n[t]) < 0 &&
                r[t] &&
                i.compareNums(e, r[t]) >= 0 &&
                o.cdbase2ver[t]
              )
  ...
  !(function() {
    ...
    ($.fn.iLightBoxHashChange = function(e) {
      return e
        ? this.bind('iLightBoxHashChange', e)
      ...
      (t = (function() {
        function t() {
          var o = e(),
            n = c(a);
          o !== a
            ? (l((a = o), n), $(window).trigger('iLightBoxHashChange'))
            : n !== a && (location.href = location.href.replace(/#.*/, '') + n),
            ...
            (function() {
              ...
              (n.start = function() {
                i ||
                  ...
                  (i = $('<iframe tabindex="-1" title="empty"/>')
                    .hide()
                    .one('load', function() {
                      r || l(e()), t();
                    })
                ...
                (l = function(e, t) {
                  ...
                  e !== t &&
                    ...
                    n.open(),
                    r &&
                      n.write('<script>document.domain="' + r + '"</script>'),
                    n.close(),
                    (i.location.hash = e));
                });
            })(),
