                ...
                <div className="clearfix content-center">
                  <ul className="list-inline flex-block clearfix">
                    ...
                    <li
                      ...
                      data-delay="400"
                    >
                      <img src={getImageURL('icons/big-data.png')} width="55" />
                      <a className="mt-10" href="#">
                        Big Data
                      </a>
                    </li>
                    ...
                    >
                      <img
                        src={getImageURL('icons/android-icon-medium@2x.png')}
                        width="55"
                      />
                      <a className="mt-10" href="#">
                        Android
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <ul className="i-list filled">
                  ...
                  <li>
                    <i className="fa fa-check" />
                    <span className="list-item">Satisfactions guaranteed.</span>
                  </li>
                </ul>
                <a
                ...
                <div className="copy">
                  <div className="intro-copy">
                    ...
                    <p className="fs-20 lh-30 o-7">
                      ...
                      everything<br /> but have my own professional websites!
                    </p>
                  </div>
                    ...
                    <article className="post-content-wrap minimal-post">
                      <div className="post-content-wrap-inner">
                        ...
                        <div className="post-meta">
                          <ul>
                            <li className="date">
                              <i className="ion-android-time" />June 16, 2017{' '}
                            </li>
                            <li>
                              <i className="fa fa-folder-o" />
                              <a href="#">Design</a>, <a href="#">Company</a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div>
                    <article className="post-content-wrap minimal-post">
                      <div className="post-content-wrap-inner">
                        ...
                        <a className="read-more fs-13" href="#" target="_self">
            ...
            <div className="row text-center">
              <div className="col-md-12">
                ...
                <p className="section-sub-title">
                  It is very convenient that i can make a lot of pages from my
                  site with uniform <br />
            ...
            <div className="row process-step v2">
              ...
              >
                ...
                <div className="process-step-content">
                  <div className="text-center process-step-stepnum">Design</div>
                  <div className="progress">
                    <div className="progress-bar" />
                  </div>
                  <a href="#" className="process-step-dot" />
                  <div className="process-step-info text-center">
                    Lorem ipsum dolor sitluctus amet. Nam mollis tristique erat
                    vel tristique.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="process-step-content">
                  ...
                  <a href="#" className="process-step-dot" />
                  <div className="process-step-info text-center">
                    Integer semper dolor ac luctus auctor luctus rutrum. Duis
                    porta luctus ipsum.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="process-step-content">
                  ...
                  <a href="#" className="process-step-dot" />
                  <div className="process-step-info text-center">
                    Curabitur mollis magna at blandit vestibulum. in faucibus
                          ...
                          <div className="item_wrapper">
                            ...
                            <div className=" down_block">
                              ...
                              <a
                                ...
                                target="_blank"
                              >
                                <span className="link_text">Learn more</span> →
                              </a>
                            </div>
                          </div>
                        </div>
